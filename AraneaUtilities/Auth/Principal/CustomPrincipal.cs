...
// ***********************************************************************
// <copyright file="CustomPrincipal.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace AraneaUtilities.Auth
{
    internal class CustomPrincipal : ICustomPrincipal
    {
        ...
        {
            bool ok = false;
            string uidSession = (string)HttpContext.Current.Session[CustomPrincipalManager.UID]; ;
        ...
        public bool SetInstanceToSession()
        {
            ...
            if (ok)
                HttpContext.Current.Session[CustomPrincipalManager.CP] = this;
            return ok;
        }
        ...
        //** se il principal è autenticato: attiva i principal nel thread
