<%@ Page Title="Lista Comunicazioni" Language="C#" MasterPageFile="~/Rental/MasterpageRental.Master" AutoEventWireup="true" CodeBehind="DetailCom.aspx.cs" Inherits="DFleet.Rental.Modules.Dash.DetailCom" %>
				    ...
				    <Columns>
					    <asp:TemplateField HeaderText="">
						    <ItemTemplate>
                                ...
                                <div class="white-box">
                                    <div class="m-b-30"><h5><%# Eval("cognome") %> </h5></div>
