                ...
                if (servizioComunicazioni.InsertComunicazione(MailNew) == 1)
                {
                    ...
                    if (data != null)
                    {
                        ...
                        else
                        {
                            ...
                            lblMessage.Text = "Inserimento avvenuto correttamente <br /> <a href='" + ResolveUrl("~/Rental/Modules/Dash/ViewComunicazioni") + "' style='color:#fff;'>Ritorna alla Lista Comunicazioni</a>";
