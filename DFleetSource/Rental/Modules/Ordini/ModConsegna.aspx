<%@ Page Title="Modifica Ordine" Language="C#" MasterPageFile="~/Rental/MasterpageRental.Master" AutoEventWireup="true" CodeBehind="ModConsegna.aspx.cs" Inherits="DFleet.Rental.Modules.Ordini.ModConsegna" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Rental/Modules/Ordini/ViewOrdiniEvasi")%>" class="btn btn-info waves-effect waves-light m-t-10">Torna alla Lista</a> 
            </div>				
        </div>
    </div>
