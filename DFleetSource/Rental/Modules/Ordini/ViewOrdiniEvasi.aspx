<%@ Page Title="Ordini evasi" Language="C#" MasterPageFile="~/Rental/MasterpageRental.Master" AutoEventWireup="true" CodeBehind="ViewOrdiniEvasi.aspx.cs" Inherits="DFleet.Rental.Modules.Ordini.ViewOrdiniEvasi" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Ordini evasi</h3>
            </div>			
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        ...
                                        <asp:ObjectDataSource ID="odsstatusordini" runat="server" SelectMethod="SelectStatusOrdineRentalEvasi" TypeName="BusinessLogic.ContrattiBL">
                                        </asp:ObjectDataSource>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlUsers" runat="server" DataSourceID="odsusers" DataTextField="cognome" 
                                            ...
                                            <asp:ListItem Selected="True" Value="00000000-0000-0000-0000-000000000000" Text="Driver"></asp:ListItem>
                                        </asp:DropDownList>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicOrdini" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Stato">
                            <ItemTemplate>
                                <%# Eval("statusordine")%>
                                <asp:HiddenField ID="hdidstatusordine" Value='<%#Eval("idstatusordine") %>' runat="server"></asp:HiddenField> 
                                <asp:HiddenField ID="hdfilefirma" Value='<%#Eval("filefirma") %>' runat="server"></asp:HiddenField> 
                                <asp:HiddenField ID="hduid" Value='<%#Eval("Uid") %>' runat="server"></asp:HiddenField>           
                            </ItemTemplate>
                        </asp:TemplateField> 
                ...
                <asp:ObjectDataSource ID="odsRicOrdini" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectRichiesteOrdiniRentalEvasi" TypeName="BusinessLogic.ContrattiBL">
                        <SelectParameters>
