<%@ Page Title="Modifica Ordine" Language="C#" MasterPageFile="~/Rental/MasterpageRental.Master" AutoEventWireup="true" CodeBehind="ModEvadi.aspx.cs" Inherits="DFleet.Rental.Modules.Ordini.ModEvadi" %>
        ...
        <div class="row">
            <div class="col-12">  
                ...
                <div class="form-actions">
                    ...
                    <asp:Button ID="btnModifica" runat="server" onclick="btnModifica_Click" Text="Evadi Ordine" CssClass="btn btn-success" />
                </div>
            </div>
        </div>
    </div>
