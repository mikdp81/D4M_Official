        ...
        protected void btnModifica_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (servizioContratti.UpdateContrattoConsegna(contrattoNew) == 1)
                {
                    ...
                    log.InsLog(Page.TemplateSourceDirectory + "/" + Page.Title, "Data Consegna Contratto:" + Uid);


                    pnlMessage.Visible = true;
                    pnlMessage.CssClass = "alert alert-success";
                    lblMessage.Text = "Aggiornamento effettuato correttamente<br /> <a href='" + ResolveUrl("~/Rental/Modules/Ordini/ViewOrdiniEvasi") + "'>Ritorna alla Lista</a>";
                }
                else
                {
                    pnlMessage.Visible = true;
