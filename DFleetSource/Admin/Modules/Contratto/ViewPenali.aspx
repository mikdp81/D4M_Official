<%@ Page Title="Lista Penali" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewPenali.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ViewPenali" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Contratto/InsPenale")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlStatus" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                                data-toggle="tooltip" data-placement="top" data-original-title="Seleziona Status">
                                            <asp:ListItem Value="">Seleziona Status</asp:ListItem>
                                            <asp:ListItem Value="DA DEFINIRE">DA DEFINIRE</asp:ListItem>
                                            <asp:ListItem Value="ACCETTATO">ACCETTATO</asp:ListItem>
                                            <asp:ListItem Value="CONTESTATO">CONTESTATO</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicPenali" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Numero fattura">
                            <ItemTemplate>
                                <%# Eval("numerofattura")%>
                            </ItemTemplate>
                        </asp:TemplateField> 
                ...
                <asp:ObjectDataSource ID="odsRicPenali" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectPenaliAuto" TypeName="BusinessLogic.ContrattiBL">
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="hdtarga" Name="targa" PropertyName="Value" Type="String" />
                        ...
                        <asp:ControlParameter ControlID="hdstatus" Name="status" PropertyName="Value" Type="String" />
                        <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="UidTenant" />
                ...
                <asp:HiddenField ID="hdidtipopenale" runat="server" />            
