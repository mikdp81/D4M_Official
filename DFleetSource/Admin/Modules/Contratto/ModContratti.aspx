<%@ Page Title="Modifica Contratto" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ModContratti.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ModContratti" %>
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-sm-12">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class=""><a href="#documenti" aria-controls="documenti" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Documenti</span></a></li>
                         ...
                         <div class="col-md-12">
                            ...
                            <div class="row">   
                                <div class="col-md-12">                                
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">KW/CV</label>
                                            <asp:TextBox ID="txtKwcv" runat="server" Columns="30" MaxLength="20" CssClass="form-control" placeholder="KW/CV"></asp:TextBox> 
                                        </div>
                                    </div>  
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Cilindrata</label>
                                            <asp:TextBox ID="txtCilindrata" runat="server" Columns="30" MaxLength="20" CssClass="form-control" placeholder="Cilindrata"></asp:TextBox> 
                                        </div>
                                    </div> 
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Alimentazione</label>
                                            <asp:TextBox ID="txtAlimentazione" runat="server" Columns="30" MaxLength="20" CssClass="form-control" placeholder="Alimentazione"></asp:TextBox> 
                                        </div>
                                    </div>  
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Libretto inviato</label><br />
                                            NO <input type="checkbox" id="flglibrettoinviato" class="js-switch" data-color="#13dafe" runat="server" /> SI<br /><br />
        ...
        <!-- Annotazioni-->
                         ...
                         <div class="col-md-12">
                            ...
                            <div class="row">   
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">In Riparazione</label>   <br />                                         
                                            NO <input type="checkbox" id="checkriparazione" class="js-switch" data-color="#13dafe" runat="server" /> SI<br /><br />
                                        </div>
                                    </div> 
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <div class="row"> 
                                <div class="col-md-12">
                                    <asp:HiddenField ID="hduidauto" runat="server" />
                                    <asp:HiddenField ID="hdidcontratto" runat="server" />
                                    <asp:HiddenField ID="hdidassegnazione_" runat="server" />
                    ...
                    <div id="storico" class="tab-pane">
                        <div class="row"> 
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary btnass" data-toggle="modal" data-target="#exampleModal2">Nuovo Driver</button>
                                
                                <button type="button" class="btn btn-primary btnass" data-toggle="modal" data-target="#exampleModal3">Nuovo Pool</button>
                                
                                <button type="button" class="btn btn-primary btnass" data-toggle="modal" data-target="#exampleModal4">Nuovo Ritiro</button>                      
                                <br /><br />
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="exampleModalLabel1">Modifica Assegnazione</h4> 
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlUserAss" runat="server" DataSourceID="odsusers" DataTextField="cognome" 
                                                        DataValueField="UserId" CssClass="form-control " AppendDataBoundItems="True">
                                                        <asp:ListItem Value="00000000-0000-0000-0000-000000000000" Text="Utente"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Societ&agrave;</label>
                                                    <asp:DropDownList ID="ddlCodSocietaMod" runat="server" DataSourceID="odssocieta" DataTextField="societa" 
                                                        DataValueField="codsocieta" CssClass="form-control select2" AppendDataBoundItems="True">
                                                        <asp:ListItem Selected="True" Value="" Text="Societa"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <asp:HiddenField ID="hdidassegnazione" runat="server" />
                                            <asp:HiddenField ID="hdistatusassegnazione" runat="server" />
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Chiudi</button>
                                            <asp:Button ID="btnModifica4" runat="server" onclick="btnModifica4_Click" Text="Salva" CssClass="btn btn-primary" />
                                        </div>
                                    </div>
                                </div>
                                <!-- FINE MODIFICA ASSEGNAZIONE -->
                                ...
                                <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4 class="modal-title" id="exampleModalLabel2">Nuova Assegnazione</h4> 
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Driver</label>
                                                    <asp:DropDownList ID="ddlUserAssNew" runat="server" DataSourceID="odsusers" DataTextField="cognome" 
                                                        DataValueField="UserId" CssClass="form-control select2" AppendDataBoundItems="True">
                                                        <asp:ListItem Value="00000000-0000-0000-0000-000000000000" Text="Utente"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Societ&agrave;</label>
                                                    <asp:DropDownList ID="ddlCodSocietaNew" runat="server" DataSourceID="odssocieta" DataTextField="societa" 
                                                        DataValueField="codsocieta" CssClass="form-control select2" AppendDataBoundItems="True">
                                                        <asp:ListItem Selected="True" Value="" Text="Societa"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Data inizio assegnazione</label>
                                                    <asp:TextBox ID="txtDataInizioAssegnazioneNew" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Data inizio assegnazione"></asp:TextBox> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Data fine assegnazione</label>
                                                    <asp:TextBox ID="txtDataFineAssegnazioneNew" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Data fine assegnazione"></asp:TextBox> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Chiudi</button>
                                            <asp:Button ID="btnModifica5" runat="server" onclick="btnModifica5_Click" Text="Salva" CssClass="btn btn-primary" />
                                        </div>
                                    </div>
                                </div>
                                <!-- FINE NUOVA ASSEGNAZIONE -->
                                ...
                                <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4 class="modal-title" id="exampleModalLabel3">Nuovo Pool</h4> 
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Driver</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Data inizio assegnazione</label>
                                                    <asp:TextBox ID="txtDataInizioAssegnazioneNewPool" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Data inizio assegnazione"></asp:TextBox> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Data fine assegnazione</label>
                                                    <asp:TextBox ID="txtDataFineAssegnazioneNewPool" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Data fine assegnazione"></asp:TextBox> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Societ&agrave;</label>                                                    
                                                    <asp:DropDownList ID="ddlSocietaNewPool" runat="server" DataSourceID="odssocieta" DataTextField="societa" 
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Chiudi</button>
                                            <asp:Button ID="btnModifica6" runat="server" onclick="btnModifica6_Click" Text="Salva" CssClass="btn btn-primary" />
                                        </div>
                                    </div>
                                </div>
                                <!-- FINE NUOVO POOL -->
                                ...
                                <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4 class="modal-title" id="exampleModalLabel4">Nuovo Ritiro</h4> 
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">Driver</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Data inizio assegnazione</label>
                                                    <asp:TextBox ID="txtDataInizioAssegnazioneNewRitiro" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Data inizio assegnazione"></asp:TextBox> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Data fine assegnazione</label>
                                                    <asp:TextBox ID="txtDataFineAssegnazioneNewRitiro" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Data fine assegnazione"></asp:TextBox> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="message-text" class="control-label">Societ&agrave;</label>                                                    
                                                    <asp:DropDownList ID="ddlSocietaNewRitiro" runat="server" DataSourceID="odssocieta" DataTextField="societa" 
                                                        DataValueField="codsocieta" CssClass="form-control" AppendDataBoundItems="True">
                                                        <asp:ListItem Selected="True" Value="" Text="Societa"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Chiudi</button>
                                            <asp:Button ID="btnModifica7" runat="server" onclick="btnModifica7_Click" Text="Salva" CssClass="btn btn-primary" />
                                        </div>
                                    </div>
                                </div>
                                <!-- FINE NUOVO RITIRO -->
                    ...
                    <div id="proroga" class="tab-pane">
                        <div class="row"> 
                            <div class="col-md-12">                             
                                ...
                                <div class="row"> 
                                    <div class="col-md-12">
                                        <asp:Button ID="btn" runat="server" onclick="btnModifica3_Click" Text="Salva" CssClass="btn btn-success" />
                                    </div>    
                                </div>       
                            </div>
                        </div>
                    ...
                    <div id="kmauto" class="tab-pane">
                        ...
                        <div class="row"> 
                            <div class="col-md-12">
                                <asp:Button ID="btnModifica8" runat="server" onclick="btnModifica8_Click" Text="Salva" CssClass="btn btn-success" />
                            </div>    
                        </div>       
                    ...
                    <div id="documenti" class="tab-pane">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="box-title colorverded">Caricamento Documenti driver</h3>
                                <hr class="m-t-0 m-b-40">
                            </div>
                        </div>
                        <div class="row">  
                            <div class="col-md-12">
                                <div class="form-group">                                    
                                    <asp:Label ID="lblNomeDriver" runat="server" Text="" CssClass="font-bold font-20"></asp:Label>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="row">                             
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="lblViewFuelCard" runat="server" Text=""></asp:Label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row"> 
                            <div class="col-md-12">
                                <asp:Button ID="btnModifica9" runat="server" onclick="btnModifica9_Click" Text="Salva" CssClass="btn btn-success" />
                            </div>    
                        </div>       
