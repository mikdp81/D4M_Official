...
// ***********************************************************************
// <copyright file="DetailAutoRunning.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class DetailAutoRunning : System.Web.UI.Page
    {
        ...
        protected void btnModifica_Click(object sender, EventArgs e)
        {
            ...
            if (contrattoNew.Idstatuscontratto == -1)
            {
                ...
                error += "inserire un valore valido per il campo Status Contratti<br />";
            }
            else
            {
            ...
            else
            {
                ...
                {
                    servizioContratti.UpdateChangeStatusContratto(SeoHelper.GuidString(hdUid.Value), contrattoNew.Idstatuscontratto, SeoHelper.ReturnSessionTenant());
