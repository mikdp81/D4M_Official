...
// ***********************************************************************
// <copyright file="ViewVolture.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewAutorizzaVolture : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountVoltureDaAutorizzare(codsocieta, UserId, marca, modello, codfornitore, numerocontratto, datadal, dataal, Uidtenant);
            ...
            lblNumRecord.Text = "Volture da autorizzare: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        {
            Response.Redirect("ViewAutorizzaVolture");
        }
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportVoltureDaAutorizzare-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["D1"].Value = "Numero Contratto";
                worksheet.Cells["E1"].Value = "Data Contratto";
                ...
                List<IContratti> dataExport = servizioContratti.SelectVoltureDaAutorizzare(codsocieta, UserId, marca, modello, codfornitore, numerocontratto, datadal, dataal, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IContratti resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["D" + countRow].Value = resultExport.Numerocontratto;
                        worksheet.Cells["E" + countRow].Value = resultExport.Datacontratto;
