...
{
    public partial class ViewRiconsegnaAuto : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountRiconsegnaAuto(targa, UserId, codfornitore, numerocontratto, datadal, dataal, idstatusassegnazione, Uidtenant);
            ...
            lblNumRecord.Text = "Restituzioni Auto: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
