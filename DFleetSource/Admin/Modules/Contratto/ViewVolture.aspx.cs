...
{
    public partial class ViewVolture : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountVolture(codsocieta, UserId, marca, modello, codfornitore, numerocontratto, datadal, dataal, idstatuscontratto, Uidtenant);
            ...
            lblNumRecord.Text = "Volture: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportVolture-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                List<IContratti> dataExport = servizioContratti.SelectVolture(codsocieta, UserId, marca, modello, codfornitore, numerocontratto, datadal, dataal, idstatuscontratto, Uidtenant, ordine, tipoordine, 10000, 1);
