...
// ***********************************************************************
// <copyright file="ViewAutoPool.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewAutoPool : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountAutoPool(codsocieta, UserId, marca, modello, codfornitore, numerocontratto, datadal, dataal, idstatuscontratto, Uidtenant);
            ...
            lblNumRecord.Text = "Contratti Auto Pool: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportAutoPool-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["B1"].Value = "N. e Data Contratto";
                worksheet.Cells["C1"].Value = "Targa";
                worksheet.Cells["D1"].Value = "CarPolicy";
                worksheet.Cells["E1"].Value = "Modello";
                worksheet.Cells["F1"].Value = "Societa";
                worksheet.Cells["G1"].Value = "Optional Canone";
                worksheet.Cells["H1"].Value = "Fringe";
                worksheet.Cells["I1"].Value = "Km Percorsi / Km Contratto";
                worksheet.Cells["J1"].Value = "Data Contratto";
                worksheet.Cells["K1"].Value = "Data Scadenza";
                worksheet.Cells["L1"].Value = "Disponibile dal";
                worksheet.Cells["M1"].Value = "Luogo consegna";
                worksheet.Cells["N1"].Value = "Condizione auto";
                worksheet.Cells["O1"].Value = "Status Pool";
                ...
                List<IContratti> dataExport = servizioContratti.SelectAutoPool(codsocieta, UserId, marca, modello, codfornitore, numerocontratto, datadal, dataal, idstatuscontratto, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IContratti resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Numerocontratto + " del " + resultExport.Datacontratto;
                        worksheet.Cells["C" + countRow].Value = resultExport.Targa;
                        worksheet.Cells["D" + countRow].Value = resultExport.Codcarpolicy;
                        worksheet.Cells["E" + countRow].Value = resultExport.Modello;
                        worksheet.Cells["F" + countRow].Value = resultExport.Codsocieta;
                        worksheet.Cells["G" + countRow].Value = resultExport.Deltacanone;
                        worksheet.Cells["H" + countRow].Value = resultExport.Fringebenefit;
                        worksheet.Cells["I" + countRow].Value = resultExport.Kmpercorsi.ToString("F2") + " / " + resultExport.Kmcontratto.ToString("F2");
                        worksheet.Cells["J" + countRow].Style.Numberformat.Format = DateTimeFormatInfo.CurrentInfo.ShortDatePattern;
                        worksheet.Cells["J" + countRow].Value = resultExport.Datacontratto;
                        worksheet.Cells["K" + countRow].Style.Numberformat.Format = DateTimeFormatInfo.CurrentInfo.ShortDatePattern;
                        worksheet.Cells["K" + countRow].Value = resultExport.Datafinecontratto;
                        worksheet.Cells["L" + countRow].Style.Numberformat.Format = DateTimeFormatInfo.CurrentInfo.ShortDatePattern;
                        worksheet.Cells["L" + countRow].Value = resultExport.Assegnatodal;
                        worksheet.Cells["M" + countRow].Value = resultExport.Luogoconsegna;
                        worksheet.Cells["N" + countRow].Value = resultExport.Statoauto;
                        worksheet.Cells["O" + countRow].Value = resultExport.Statusassegnazione;
