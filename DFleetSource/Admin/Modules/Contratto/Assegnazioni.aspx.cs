...
{
    public partial class Assegnazioni : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int idstatusassegnazione = SeoHelper.IntString(ddlstatus.SelectedValue);
            Guid Uidtenant = SeoHelper.ReturnSessionTenant();
            int totaleRecord = Convert.ToInt32(ddlNRecord.SelectedValue);
            int totaleRighe = servizioContratti.SelectCountAssegnazioniContratti(targa, targasearch, UserId, codfornitore, numerocontratto, datadal, dataal, idstatusassegnazione, Uidtenant);
            ...
            lblNumRecord.Text = "Assegnazioni Contratti: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                List<IContratti> dataExport = servizioContratti.SelectAssegnazioniContratti(targa, targasearch, UserId, codfornitore, numerocontratto, datadal, dataal, idstatusassegnazione, Uidtenant, ordine, tipoordine, 100000, 1);
