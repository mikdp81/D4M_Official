<%@ Page Title="Assegnazioni" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="Assegnazioni.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.Assegnazioni" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Assegnazioni</h3>
            </div>				
        </div>
    </div>
                ...
                <asp:GridView ID="gvRicContratti" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='../Ordini/EditConsegna-<%# Eval("idassegnazione")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Consegna">Consegna</a> <br />
                                ...
                                <a href='DelAssegnazione-<%# Eval("idassegnazione")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Elimina">Elimina</a> 
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicContratti" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectAssegnazioniContratti" TypeName="BusinessLogic.ContrattiBL">
                    <SelectParameters>
