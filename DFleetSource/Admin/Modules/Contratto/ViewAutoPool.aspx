<%@ Page Title="Lista Auto Pool" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewAutoPool.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ViewAutoPool" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                <h3 class="box-title m-b-0">Lista Auto Pool</h3>
            </div>			
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicContratti" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Modello CarPolicy Fornitore">
                            <ItemTemplate>
                                <%# Eval("modello")%><br />
                                <%# Eval("codcarpolicy")%><br />
                                  <%# Eval("fornitore")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Km percorsi <br> Km totali">
                            <ItemTemplate>
                                <%# String.Format(CultureInfo.CurrentCulture, "{0:F2}",Eval("kmpercorsi")) %>  <br /> 
                ...
                <asp:ObjectDataSource ID="odsRicContratti" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectAutoPool" TypeName="BusinessLogic.ContrattiBL">
                    <SelectParameters>
