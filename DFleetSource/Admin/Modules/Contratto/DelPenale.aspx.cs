    ...
    public partial class DelPenale : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {                
                ...
                //cancella penale
                IContratti penaleDel = new Contratti
                {
                    Uid = uid,
                    Uidtenant = SeoHelper.ReturnSessionTenant()
                };

                if (servizioContratti.DeletePenali(penaleDel) == 1)
                {
                    ...
                    lblMessage.Text = "Cancellazione avvenuta correttamente <br /> <a href='" + ResolveUrl("~/Admin/Modules/Contratto/ViewPenali") + "'>Ritorna alla Lista</a>";
                }
                else
                {
                    pnlMessage.Visible = true;
