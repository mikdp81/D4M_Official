<%@ Page Title="Lista Contratti" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewContratti.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ViewContratti" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Contratto/InsContratti")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                ...
                                <a href='DelContratti-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questo contratto?');" class="text-inverse" title="" data-placement="left" data-toggle="tooltip" data-original-title="Cancella"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a> 
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicContratti" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectContratti" TypeName="BusinessLogic.ContrattiBL">
                    <SelectParameters>
