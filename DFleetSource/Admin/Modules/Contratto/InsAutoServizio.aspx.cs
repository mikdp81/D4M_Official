...
namespace DFleet.Admin.Modules.Contratto
{
    public partial class InsAutoServizio : System.Web.UI.Page
    {
        ...
        protected void btnInserisci_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(hduiduser.Value))
            {
                txtUsers.CssClass = "form-control autouser is-invalid";
                error += "inserire un driver<br />";
            }
            else
            {
                txtUsers.CssClass = "form-control autouser";
            }
        ...
        public string ReturnEvent()
        {
            ...
            if (data != null && data.Count > 0)
            {
                foreach (IContratti result in data)
                {
                    ...
                    retVal += "{";
                    retVal += "title: '" + result.Noteamministrazione + " " + result.Cognome + "', ";
        ...
        protected void btnIns_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    UserId = SeoHelper.GuidString(hduiduser.Value),
                    Targa = targa,
        ...
        protected void btnInserisci2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    elencoauto += "<table width='100%' cellpadding='0' cellspacing='0' border='0'>";
