<%@ Page Title="Modifica Auto Sostitutiva" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ModAutoSost.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ModAutoSost" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Modifica Auto Sostitutiva</h3>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="form-action">
                    ...
                    <asp:Button ID="btnElimina" runat="server" onclick="btnElimina_Click" Text="Elimina" OnClientClick="return confirm('Sei sicuro di voler cancellare questa auto sostitutiva?');" CssClass="btn btn-success" />
                </div> 
            </div> 
        </div>
    </div>
