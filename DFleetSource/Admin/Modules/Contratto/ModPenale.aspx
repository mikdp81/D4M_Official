<%@ Page Title="Modifica Penale" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ModPenale.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ModPenale" %>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:HiddenField ID="hdFilePenale" runat="server" />
