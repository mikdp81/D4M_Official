<%@ Page Title="Lista TelePass/ ViaCard Driver" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewTelePassDriver.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ViewTelePassDriver" %>
                ...
                <asp:GridView ID="gvTelePass" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='../Users/EditTelePassDriver-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip"  data-placement="left" title="" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
