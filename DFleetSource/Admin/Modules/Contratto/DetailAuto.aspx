<%@ Page Title="Auto" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="DetailAuto.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.DetailAuto" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Contratto/ViewAutoPool")%>" class="btn btn-info waves-effect waves-light m-t-10">Torna alla Lista</a> 
            </div>		
        </div>
    </div>
                        ...
                        <div class="col-12">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlstatus" runat="server" DataSourceID="odsstatus" DataTextField="statusassegnazione" 
                                        DataValueField="idstatusassegnazione" CssClass="form-control" AppendDataBoundItems="True">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtLuogo" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Luogo consegna"></asp:TextBox> 
                                </div>
                            </div>  
                        </div> 
                    </div>
