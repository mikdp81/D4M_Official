<%@ Page Title="Lista Running Fleet" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewRunningFleet.aspx.cs" Inherits="DFleet.Admin.Modules.Contratto.ViewRunningFleet" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                <h3 class="box-title m-b-0">Lista Running Fleet</h3>
            </div>			
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicContratti" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Km Percorsi / Km Contratto">
                            <ItemTemplate>
                                <%# String.Format(CultureInfo.CurrentCulture, "{0:F2}",Eval("kmpercorsi")) %>  / 
                                <%# String.Format(CultureInfo.CurrentCulture, "{0:F2}",Eval("kmcontratto")) %> 
                            </ItemTemplate>
                        </asp:TemplateField>                                                 
                        
                        <asp:TemplateField HeaderText="Inizio Assegnazione">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Condizione auto">
                            <ItemTemplate>
                                <%# Eval("statoauto")%>                     
                            </ItemTemplate>
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href="DetailAutoRunning-<%# Eval("Uid")%>" class="text-inverse p-r-10" data-toggle="tooltip" data-placement="left" title="" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                                <a href="../Ordini/ViewFileAuto" target="_blank" class="text-inverse p-r-10" data-toggle="tooltip" data-placement="left" title="" data-original-title="Documenti"><img src="../../../plugins/images/documenti.svg" class="icon20" border="0" alt="" /></a>
                            </ItemTemplate>                                
                        </asp:TemplateField>                            
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicContratti" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectRunningFleet" TypeName="BusinessLogic.ContrattiBL">
                    <SelectParameters>
