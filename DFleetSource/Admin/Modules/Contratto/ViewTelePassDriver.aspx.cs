...
// ***********************************************************************
// <copyright file="ViewTelePassDriver.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewTelePassDriver : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            Recuperadatiuser datiUtente = new Recuperadatiuser();
            if (!datiUtente.ReturnExistPage(69)) //controllo se la pagina è autorizzata per l'utente 
            {
        ...
        public void loadPage()
        {
            ...
            string stato = SeoHelper.EncodeString(ddlStatus.SelectedValue);
            ...
            int totaleRighe = servizioAccount.SelectCountTelePassUser(search, UserId, datadal, dataal, idcompagnia, stato, Uidtenant);
            ...
            if (gvTelePass.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvTelePass.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
            ...
            lblNumRecord.Text = "Tele Pass Driver: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
                lblMessage.Text = "Nessun dato disponibile. Ricerca con altri parametri.";
                pnlMessage.Visible = true;
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportTelePassDriver-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["D1"].Value = "Scadenza";
                worksheet.Cells["E1"].Value = "Compagnia";
                ...
                List<IAccount> dataExport = servizioAccount.SelectTelePassUser(search, UserId, datadal, dataal, idcompagnia, stato, Uidtenant, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Cognome + " " + resultExport.Nome + "(" + resultExport.Matricola + ")";
                        worksheet.Cells["B" + countRow].Value = resultExport.Targa;
                        worksheet.Cells["C" + countRow].Value = resultExport.Numero;
                        worksheet.Cells["D" + countRow].Value = resultExport.Scadenza;
                        worksheet.Cells["E" + countRow].Value = resultExport.Compagnia;
