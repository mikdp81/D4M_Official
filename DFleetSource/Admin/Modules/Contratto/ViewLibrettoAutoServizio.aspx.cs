...
// ***********************************************************************
// <copyright file="ViewLibrettoAutoServizio.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewLibrettoAutoServizio : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("ViewLibrettoAutoServizio");
        }
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountLibrettoAutoServizio(targa,  UserId, Uidtenant);
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportLibrettoAutoServizio-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                List<IContratti> dataExport = servizioContratti.SelectLibrettoAutoServizio(targa, UserId, Uidtenant, ordine, tipoordine, 100000, 1);
