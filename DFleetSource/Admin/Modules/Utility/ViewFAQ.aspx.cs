...
// ***********************************************************************
// <copyright file="ViewFAQ.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace DFleet.Admin.Modules.Utility
{
    public partial class ViewFAQ : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int idargomentofaq = SeoHelper.IntString(ddlArgomento.SelectedValue);
            Guid Uidtenant = SeoHelper.ReturnSessionTenant();
            int totaleRecord = Convert.ToInt32(ddlNRecord.SelectedValue);
            int totaleRighe = servizioUtility.SelectCountFAQ(keysearch, idargomentofaq, Uidtenant);
            ...
            if (gvRicFAQ.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicFAQ.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "FAQ: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportFAQ-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Argomento";
                worksheet.Cells["B1"].Value = "FAQ";
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectFAQ(keysearch, idargomentofaq, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Argomento;
                        worksheet.Cells["B" + countRow].Value = resultExport.Domanda;
