<%@ Page Title="Lista Argomenti FAQ" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewArgomentiFAQ.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.ViewArgomentiFAQ" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Lista Argomenti FAQ</h3>
            </div>
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Utility/insArgomentoFAQ")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlOrdina" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                            ...
                                            <asp:ListItem Value="argomento">Argomento</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicArgomentiFAQ" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsRicArgomentiFAQ" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='EditArgomentoFAQ-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                                <a href='DelArgomentoFAQ-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questo argomento?');" class="text-inverse" title="" data-toggle="tooltip" data-placement="left" data-original-title="Cancella"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a>
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicArgomentiFAQ" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectArgomentoFAQ" TypeName="BusinessLogic.UtilitysBL">
                    <SelectParameters>
