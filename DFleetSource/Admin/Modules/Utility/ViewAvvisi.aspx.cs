...
// ***********************************************************************
// <copyright file="ViewAvvisi.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewAvvisi: System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountAvvisi(keysearch, Uidtenant);
            ...
            if (gvAvvisi.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvAvvisi.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Avvisi: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
