<%@ Page Title="Inserimento FAQ" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="insFAQ.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.insFAQ" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Inserimento FAQ</h3>
            </div>
