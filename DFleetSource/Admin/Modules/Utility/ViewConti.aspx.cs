...
// ***********************************************************************
// <copyright file="ViewConti.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewConti : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountConti(keysearch, Uidtenant);
            ...
            if (gvRicConti.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicConti.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Conti: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportConti-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Codice Conto";
                worksheet.Cells["B1"].Value = "Codice Società";
                worksheet.Cells["C1"].Value = "Service Area";
                worksheet.Cells["D1"].Value = "Descrizione Conto";
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectConti(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Codconto;
                        worksheet.Cells["B" + countRow].Value = resultExport.Codsocieta;
                        worksheet.Cells["C" + countRow].Value = resultExport.Servicearea;
                        worksheet.Cells["D" + countRow].Value = resultExport.Descrizioneconto;
