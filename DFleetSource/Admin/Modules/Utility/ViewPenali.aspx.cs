...
namespace DFleet.Admin.Modules.Utility
{
    public partial class ViewPenali : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountPenali(codsocieta, codgrade, Uidtenant);
            ...
            if (gvRicPenale.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicPenale.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectPenali(codsocieta, codgrade, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Siglasocieta;
                        worksheet.Cells["B" + countRow].Value = resultExport.Grade;
                        worksheet.Cells["C" + countRow].Value = resultExport.Importopenale;
                        worksheet.Cells["D" + countRow].Value = resultExport.Tipopenale;
