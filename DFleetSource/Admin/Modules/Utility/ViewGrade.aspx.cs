...
// ***********************************************************************
// <copyright file="ViewGrade.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace DFleet.Admin.Modules.Utility
{
    public partial class ViewGrade : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountGrade(keysearch, Uidtenant);
            ...
            if (gvRicGrade.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicGrade.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Grade: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportGrade-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Codice Grade";
                worksheet.Cells["B1"].Value = "Grade";
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectGrade(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Codgrade;
                        worksheet.Cells["B" + countRow].Value = resultExport.Grade;
