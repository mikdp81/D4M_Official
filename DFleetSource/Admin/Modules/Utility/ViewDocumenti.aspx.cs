...
// ***********************************************************************
// <copyright file="ViewDocumenti.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewDocumenti : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int idcategoria = SeoHelper.IntString(ddlCatDoc.SelectedValue);
            int totaleRecord = Convert.ToInt32(ddlNRecord.SelectedValue);
            int totaleRighe = servizioUtility.SelectCountDocumenti(keysearch, idcategoria, Uidtenant);
            ...
            lblNumRecord.Text = "Documenti: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportDocumenti-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Nome Documento";
                worksheet.Cells["B1"].Value = "Società";
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectDocumenti(keysearch, idcategoria, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Nomedocumento;
                        worksheet.Cells["B" + countRow].Value = resultExport.Codsocieta;
                        worksheet.Cells["C" + countRow].Value = resultExport.Codgrade;
