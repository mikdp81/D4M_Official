...
// ***********************************************************************
// <copyright file="ViewFornitori.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewFornitori : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountFornitori(keysearch, Uidtenant);
            ...
            if (gvRicFornitori.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicFornitori.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Fornitori: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportFornitori-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Codice Fornitore";
                worksheet.Cells["B1"].Value = "Fornitore";
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectFornitori(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IUtilitys resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Fornitore;
