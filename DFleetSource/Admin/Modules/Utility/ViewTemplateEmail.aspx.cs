...
// ***********************************************************************
// <copyright file="ViewTemplateEmail.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewTemplateEmail : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountTemplateEmail(keysearch, Uidtenant);

            if (gvRicTemplate.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicTemplate.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Template: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        {
            Response.Redirect("ViewTemplateEmail");
        }
    }
}
