...
// ***********************************************************************
// <copyright file="ViewStoricoDocumenti.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewStoricoDocumenti : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            Recuperadatiuser datiUtente = new Recuperadatiuser();
            if (!datiUtente.ReturnExistPage(34)) //controllo se la pagina è autorizzata per l'utente 
            {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountDocumenti(keysearch, datadal, dataal, Uidtenant);
            ...
            if (gvRicDoc.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicDoc.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
        ...
        {
            Response.Redirect("ViewStoricoDocumenti");
        }
