<%@ Page Title="Lista Conti" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewConti.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.ViewConti" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Lista Conti</h3>
            </div>
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Utility/InsConti")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlOrdina" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                            ...
                                            <asp:ListItem Value="codconto">Codice Conto</asp:ListItem>
                                            <asp:ListItem Value="codsocieta">Codice Societ&agrave;</asp:ListItem>
                                            <asp:ListItem Value="descrizioneconto">Descrizione</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group row marginbottmnull">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtSearch" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Codice / Descrizione"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div>                            
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicConti" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsRicConti" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descrizione">
                            <ItemTemplate>
                                <%# Eval("Descrizioneconto")%>
                            </ItemTemplate>
                        </asp:TemplateField>                     
                    
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='EditConti-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                                <a href='DelConti-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questo conto?');" class="text-inverse" title="" data-toggle="tooltip" data-placement="left" data-original-title="Cancella"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a> 
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicConti" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectConti" TypeName="BusinessLogic.UtilitysBL">
                    <SelectParameters>
