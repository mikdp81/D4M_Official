...
// ***********************************************************************
// <copyright file="ViewCentri.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewCentri : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountCentri(keysearch, Uidtenant);
            ...
            if (gvRicCentri.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicCentri.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Centri: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportCentri-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Centro";
                worksheet.Cells["B1"].Value = "Citta";
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectCentri(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Citta;
                        worksheet.Cells["B" + countRow].Value = resultExport.Centro;
