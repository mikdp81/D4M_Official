...
namespace DFleet.Admin.Modules.Utility
{
    public partial class ViewRevisioni : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            if (!datiUtente.ReturnExistPage(91)) //controllo se la pagina è autorizzata per l'utente 
            {
        ...
        public void loadPage()
        {
            ...
            int statuscheck = SeoHelper.IntString(ddlCheck.SelectedValue);
            Guid Uidtenant = SeoHelper.ReturnSessionTenant();
            int totaleRecord = Convert.ToInt32(ddlNRecord.SelectedValue);
            int totaleRighe = servizioContratti.SelectCountRevisioniAll(UserId, targa, anno, statuscheck, Uidtenant);
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                worksheet.Cells["C1"].Value = "Revisione del";
                worksheet.Cells["C1"].Value = "Esito";
                ...
                List<IContratti> dataExport = servizioContratti.SelectRevisioniAll(UserId, targa, anno, statuscheck, Uidtenant, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IContratti resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["C" + countRow].Value = resultExport.Mese + "/" + resultExport.Anno;
                        worksheet.Cells["D" + countRow].Value = ReturnEsito(resultExport.Datacheck.ToString(), resultExport.Idstatuscontratto.ToString());
