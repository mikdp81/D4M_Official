<%@ Page Title="Lista Fuel Card" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewFuelCard.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.ViewFuelCard" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Lista Fuel Card</h3>
            </div>
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Utility/InsFuelCard")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlOrdina" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                            ...
                                            <asp:ListItem Value="codfuelcard">Codice Fuel Card</asp:ListItem>
                                            <asp:ListItem Value="fuelcard">Fuel Card</asp:ListItem>
                                            <asp:ListItem Value="valorefuelcard">Valore Fuel Card</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group row marginbottmnull">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtSearch" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Codice / Fuel Card"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div>                            
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicFuelCard" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsRicFuelCard" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Codice Fuel Card">
                            <ItemTemplate>
                               <%# Eval("Codfuelcard")%>
                            </ItemTemplate>
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Valore Fuel Card">
                            <ItemTemplate>
                               <%# Eval("Valorefuelcard")%>
                            </ItemTemplate>
                        </asp:TemplateField>                   
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='EditFuelCard-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                                <a href='DelFuelCard-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questa fuel card?');" class="text-inverse" title="" data-placement="left" data-toggle="tooltip" data-original-title="Cancella"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a>  
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicFuelCard" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectFuelCard" TypeName="BusinessLogic.UtilitysBL">
                    <SelectParameters>
