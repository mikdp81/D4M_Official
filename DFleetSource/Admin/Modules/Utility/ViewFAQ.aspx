<%@ Page Title="Lista FAQ" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewFAQ.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.ViewFAQ" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Lista FAQ</h3>
            </div>
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Utility/insFAQ")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlOrdina" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                            ...
                                            <asp:ListItem Value="fa.argomento">Argomento</asp:ListItem>
                                            <asp:ListItem Value="f.validadal">Valida dal</asp:ListItem>
                                            <asp:ListItem Value="f.validaal">Valida al</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group row marginbottmnull">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtSearch" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Domanda"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div>   
        ...
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicFAQ" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsRicFAQ" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Argomento">
                            <ItemTemplate>
                               <%# Eval("Argomento")%>
                            </ItemTemplate>        
                            <ItemStyle Width="20%" />
                        ...
                        <asp:TemplateField HeaderText="FAQ">
                            <ItemTemplate>
                               <div class="text-break width300"><%# Eval("Domanda")%></div>
                            </ItemTemplate>        
                            <ItemStyle Width="60%" />
                        </asp:TemplateField>                    
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='EditFAQ-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                                <a href='DelFAQ-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questa FAQ?');" class="text-inverse" title="" data-toggle="tooltip" data-placement="left" data-original-title="Cancella"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a>
                            </ItemTemplate>         
                            <ItemStyle Width="15%" />                               
                        </asp:TemplateField>     
                    </Columns>    
                ...
                <asp:ObjectDataSource ID="odsRicFAQ" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectFAQ" TypeName="BusinessLogic.UtilitysBL">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtSearch" Name="keysearch" PropertyName="Text" Type="String" />
                        <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="UidTenant" />
                        <asp:ControlParameter ControlID="ddlArgomento" Name="idargomentofaq" PropertyName="SelectedValue" Type="Int32" />
