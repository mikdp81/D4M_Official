<%@ Page Title="Modifica Documento" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ModDoc.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.ModDoc" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Modifica Documento</h3>
            </div>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:HiddenField ID="hdFileDoc" runat="server" />
                                <asp:Label ID="lblViewFileDoc" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="row"> 
