<%@ Page Title="Lista Avvisi" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewAvvisi.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.ViewAvvisi" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Lista Avvisi</h3>
            </div>
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Utility/InsAvvisi")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                    ...
                    <div class="form-group row marginbottmnull">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtSearch" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Avviso"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div>                     
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvAvvisi" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsAvvisi" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Avviso">
                            <ItemTemplate>
                                <div class="text-break width300"><%# Eval("testoavviso")%></div>
                            </ItemTemplate>
                        </asp:TemplateField>  
                    
                        <asp:TemplateField HeaderText="Visibile">
                            <ItemTemplate>
                               Dal  <%# String.Format(CultureInfo.CurrentCulture, "{0:d}",Eval("visibiledal")) %>
                                Al  <%# String.Format(CultureInfo.CurrentCulture, "{0:d}",Eval("visibileal")) %>
                            </ItemTemplate>
                        </asp:TemplateField>                     
                    
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='EditAvvisi-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                                <a href='DelAvvisi-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questo avvisi?');" class="text-inverse" title="" data-toggle="tooltip" data-placement="left" data-original-title="Cancella"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a>
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsAvvisi" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectAvvisi" TypeName="BusinessLogic.UtilitysBL">
                    <SelectParameters>
