...
// ***********************************************************************
// <copyright file="ViewArgomentiFAQ.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewArgomentiFAQ : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountArgomentoFAQ(keysearch, Uidtenant);
            ...
            if (gvRicArgomentiFAQ.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicArgomentiFAQ.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Argomenti FAQ: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportArgomentiFAQ-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectArgomentoFAQ(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
