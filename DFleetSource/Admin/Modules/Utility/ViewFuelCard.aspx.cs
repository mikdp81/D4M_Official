...
// ***********************************************************************
// <copyright file="ViewFuelCard.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewFuelCard : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioUtility.SelectCountFuelCard(keysearch, Uidtenant);
            ...
            if (gvRicFuelCard.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicFuelCard.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Fuel Card: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportFuelCard-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Codice Fuel Card";
                worksheet.Cells["B1"].Value = "Fuel Card";
                worksheet.Cells["C1"].Value = "Valore Fuel Card";
                ...
                List<IUtilitys> dataExport = servizioUtility.SelectFuelCard(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Codfuelcard;
                        worksheet.Cells["B" + countRow].Value = resultExport.Fuelcard;
                        worksheet.Cells["C" + countRow].Value = resultExport.Valorefuelcard;
