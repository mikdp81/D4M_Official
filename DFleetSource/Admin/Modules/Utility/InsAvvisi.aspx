<%@ Page Title="Inserimento Avviso" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="InsAvvisi.aspx.cs" Inherits="DFleet.Admin.Modules.Utility.InsAvvisi" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Inserimento Avviso</h3>
            </div>
