<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="dash-flotta.aspx.cs" Inherits="DFleet.Admin.Modules.Dash.dash_flotta" %>
    ...
    <div class="row">
                    <div class="col-md-4">
                        <div class="white-box  bg-black  ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-12">
                                    <span class="text-white font-light"><asp:Label ID="lblautoincircolazione" runat="server" Text=""></asp:Label></span>
                                    <p class="font-12">Auto in circolazione ora</p>
                                </div>                     
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="white-box bg-black ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-12">
                                    <span class="text-white font-light"><asp:Label ID="lblautoinpool" runat="server" Text=""></asp:Label></span>
                                    <p class="font-12">Auto in circolazione disponibili (pool)</p>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="white-box bg-black ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-12">
                                    <span class="text-white font-light"><asp:Label ID="lblsaldoauto" runat="server" Text=""></asp:Label></span>
                                    <p class="font-12">Nuove auto <%=DateTime.Now.Year %></p>
                                </div>
                               ...
                               <div class="task-widget t-a-c">
                                 <div class="task-content font-16 t-a-c">
                                    <div class="col-sm-6 b-r">
                                        In consegna nel mese
                                        <h1 class="text-primary"><asp:Label ID="lblmeseconsegna" runat="server" Text=""></asp:Label> </h1>
                                    </div>
                                    <div class="col-sm-6">
                                        In consegna nell'anno
                                        <h1 class="text-primary"><asp:Label ID="lblannoconsegna" runat="server" Text=""></asp:Label> </h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                 <div class="white-box bg-verde color-box">
                                    <h1 class="text-white font-light m-b-0"><asp:Label ID="lblkmmedi" runat="server" Text=""></asp:Label></h1>
                                    <span class="hr-line"></span>
                                    <p class="cb-text">km medi</p>
                                    <div class="chart">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="white-box bg-verde color-box">
                                    <h1 class="text-white font-light m-b-0"><asp:Label ID="lbletamedia" runat="server" Text=""></asp:Label></h1>
                                    <span class="hr-line"></span>
                                    <p class="cb-text">Età media (anni)</p>
                                    <div class="chart">
                                        <div class="ct-visit chart-pos"><div class="chartist-tooltip"></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-2" style="padding-right:0;">
                <div style="background-color:#89BA17;height:35px;">
                    <div style="padding-left:20px;font-size:25px;color:#fff;font-style:italic;font-weight:700">Status contratto</div>
                </div>
            </div>
            ...
            <div class="row" id="container_flotta1" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta1" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaStatusContratto" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                    ...
                    <table class="display nowrap" cellspacing="0" align="Center" style="width:100%;border-collapse:collapse;">
		                <tbody>
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Label ID="lblTot1" runat="server" Text="" CssClass="text-black"><%=ReturnTotale("statuscontratto")%></asp:Label>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row" id="container_flotta4" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta4" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaSocieta" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta5" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta5" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaGrade" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource>
            ...
            <div class="row" id="container_flotta6" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta6" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaSedeDriver" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta7" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta7" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaFornitore" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta8" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta8" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaFornitoreCanone" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta9" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta9" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaMarca" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta10" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta10" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaAnnualita" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta11" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta11" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashFlottaAlimentazione" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
...
<script>
    ...
    const data1 = {
        labels: [<%=ReturnValoriAuto("statuscontratto", "SI")%>],
        datasets: [{
            label: 'Status Contratto',
            data: [<%=ReturnValoriAuto("statuscontratto", "")%>],
            backgroundColor: [
                "#537B27", 
                "#6C9934",
                "#87bd32",
