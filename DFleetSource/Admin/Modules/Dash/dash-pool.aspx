<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="dash-pool.aspx.cs" Inherits="DFleet.Admin.Modules.Dash.dash_pool" %>
    ...
    <div class="row">
                    <div class="col-md-4">
                        <div class="white-box  bg-black  ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-12">
                                    <span class="text-white font-light"><asp:Label ID="lblautototali" runat="server" Text=""></asp:Label></span>
                                    <p class="font-12">Totali</p>
                                </div>                     
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="white-box bg-black ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-6">
                                    <span class="text-white font-light"><asp:Label ID="lblready" runat="server" Text=""></asp:Label></span>
                                    <p class="font-12">Ready</p>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="white-box bg-black ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-6">
                                    <span class="text-white font-light"><asp:Label ID="lbldariparare" runat="server" Text=""></asp:Label></span>
                                    <p class="font-12">Da riparare</p>
                                </div>
            ...
            <div class="row" id="container_flotta1" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta1" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashPoolStatus" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
            ...
            <div class="row" id="container_flotta4" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta4" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashPoolSocieta" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta7" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta7" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashPoolFornitore" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta8" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta8" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashPoolFornitoreCanone" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta9" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta9" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashPoolMarca" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta10" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta10" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashPoolAnnualita" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
            ...
            <div class="row" id="container_flotta11" style="display:none;">
                <div class="col-md-4">
                    ...
                    <asp:ObjectDataSource ID="odsFlotta11" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectDashPoolAlimentazione" TypeName="BusinessLogic.UtilitysBL">
                        <SelectParameters>
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                        </SelectParameters>
                    </asp:ObjectDataSource> 
