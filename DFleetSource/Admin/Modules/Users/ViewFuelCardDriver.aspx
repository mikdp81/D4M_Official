<%@ Page Title="Lista Fuel Card Driver" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewFuelCardDriver.aspx.cs" Inherits="DFleet.Admin.Modules.Users.ViewFuelCardDriver" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Lista Fuel Card Driver</h3>
            </div>
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Users/insFuelCardDriver")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                    ...
                    <div class="form-group row marginbottmnull">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull"> 
                                        ...
                                        <asp:ObjectDataSource ID="odscompagnia" runat="server" SelectMethod="SelectCompagnieFuel" TypeName="BusinessLogic.AccountBL">
                                        </asp:ObjectDataSource>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtDatadal" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Scadenza dal"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div> 
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtDataal" runat="server" Columns="30" MaxLength="10" CssClass="form-control datePicker" placeholder="Scadenza al"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvFuelCard" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Driver">
                            <ItemTemplate>
                                <%# Eval("cognome")%> <%# Eval("nome")%> <br /> <%# Eval("matricola")%> <br /> <%# Eval("gradecode")%> <br />
                                <%# ReturnData(Eval("datainiziovalidita").ToString()) %> - <%# ReturnData(Eval("datascadenza").ToString()) %>
                            </ItemTemplate>
                        </asp:TemplateField>   
                        ...
                        <asp:TemplateField HeaderText="Attivazione">
                            <ItemTemplate>
                                <%# String.Format(CultureInfo.CurrentCulture, "{0:d}",Eval("dataattivazione")) %>         
                            </ItemTemplate>
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='EditFuelCardDriver-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip"  data-placement="left" title="" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                ...
                <asp:ObjectDataSource ID="odsFuelCard" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectFuelCardUser" TypeName="BusinessLogic.AccountBL">
                        <SelectParameters>
