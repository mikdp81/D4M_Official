<%@ Page Title="Consumi FuelCard" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewFuelCardConsumi.aspx.cs" Inherits="DFleet.Admin.Modules.Users.ViewFuelCardConsumi" %>
                ...
                <asp:GridView ID="gvConsumi" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='DelConsumoFuel-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questo consumo?');" data-toggle="tooltip" data-placement="left" title="" data-original-title="Elimina"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a>                            
                             </ItemTemplate>                                
                        </asp:TemplateField>   
                    </Columns>    
