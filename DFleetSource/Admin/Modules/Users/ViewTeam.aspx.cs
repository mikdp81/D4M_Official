...
// ***********************************************************************
// <copyright file="ViewTeam.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace DFleet.Admin.Modules.Users
{
    public partial class ViewTeam : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioAccount.SelectCountTeam(search, Uidtenant);
            ...
            if (gvRicTeam.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicTeam.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
            ...
            lblNumRecord.Text = "Team: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
                lblMessage.Text = "Nessun dato disponibile. Ricerca con altri parametri.";
                pnlMessage.Visible = true;
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportTeam-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Team";

                //righe 
                string search = SeoHelper.EncodeString(txtSearch.Text);
                Guid Uidtenant = SeoHelper.ReturnSessionTenant();

                List<IAccount> dataExport = servizioAccount.SelectTeam(search, Uidtenant, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Team;
