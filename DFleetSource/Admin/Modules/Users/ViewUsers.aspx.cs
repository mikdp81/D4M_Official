...
// ***********************************************************************
// <copyright file="ViewUsers.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace DFleet.Admin.Modules.Users
{
    public partial class ViewUsers : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            string username = SeoHelper.EncodeString(txtUsers.Text);
            int idstatususer = Convert.ToInt32(ddlstatus.SelectedValue);
            int idgruppouser = Convert.ToInt32(ddlgruppo.SelectedValue);
            Guid Uidtenant = SeoHelper.ReturnSessionTenant();
            int totaleRecord = Convert.ToInt32(ddlNRecord.SelectedValue);
            int totaleRighe = servizioAccount.SelectCountUsername(username, idstatususer, idgruppouser, Uidtenant);
            ...
            if (gvRicUsers.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicUsers.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
            ...
            lblNumRecord.Text = "Anagrafiche: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
                lblMessage.Text = "Nessun dato disponibile. Ricerca con altri parametri.";
                pnlMessage.Visible = true;
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportUtenti-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["E1"].Value = "Ruolo";
                ...
                List<IAccount> dataExport = servizioAccount.SelectUsername(username, idstatususer, idgruppouser, Uidtenant, ordine, tipoordine, 100000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IAccount resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["C" + countRow].Value = resultExport.Codsocieta;
                        worksheet.Cells["D" + countRow].Value = resultExport.Gradecode;
                        worksheet.Cells["E" + countRow].Value = resultExport.Gruppouser;
                        worksheet.Cells["F" + countRow].Value = resultExport.Statusutente;
