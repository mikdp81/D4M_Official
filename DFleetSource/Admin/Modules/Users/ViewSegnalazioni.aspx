<%@ Page Title="Lista Segnalazioni" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewSegnalazioni.aspx.cs" Inherits="DFleet.Admin.Modules.Users.ViewSegnalazioni" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Lista Segnalazioni</h3>
            </div>				
        </div>
    </div>
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvSegnalazioni" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsSegnalazioni" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Segnalazione">
                            <ItemTemplate>
                                <%# Eval("segnalazione")%>
                            </ItemTemplate>
                        </asp:TemplateField>     
                ...
                <asp:ObjectDataSource ID="odsSegnalazioni" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectSegnalazioni" TypeName="BusinessLogic.AccountBL">
                        <SelectParameters>
