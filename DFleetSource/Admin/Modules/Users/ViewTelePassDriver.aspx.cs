...
namespace DFleet.Admin.Modules.Users
{
    public partial class ViewTelePassDriver : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioAccount.SelectCountTelePassUser(search, UserId, datadal, dataal, idcompagnia, "", Uidtenant);
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                List<IAccount> dataExport = servizioAccount.SelectTelePassUser(search, UserId, datadal, dataal, idcompagnia, "", Uidtenant, 10000, 1);
