...
// ***********************************************************************
// <copyright file="ViewSegnalazioni.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewSegnalazioni : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            Recuperadatiuser datiUtente = new Recuperadatiuser();
            if (!datiUtente.ReturnExistPage(38)) //controllo se la pagina è autorizzata per l'utente 
            {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioAccount.SelectCountSegnalazioni(UserId, Uidtenant);
            ...
            if (gvSegnalazioni.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvSegnalazioni.HeaderRow.TableSection = TableRowSection.TableHeader;
            }
            ...
            lblNumRecord.Text = "Segnalazioni: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
                lblMessage.Text = "Nessun dato disponibile. Ricerca con altri parametri.";
                pnlMessage.Visible = true;
        ...
        {
            Response.Redirect("ViewSegnalazioni");
        }
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportSegnalazioni-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["B1"].Value = "Segnalazione";

                //righe 
                Guid UserId = SeoHelper.GuidString(hdusers.Value);
                Guid Uidtenant = SeoHelper.ReturnSessionTenant();

                List<IAccount> dataExport = servizioAccount.SelectSegnalazioni(UserId, Uidtenant, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IAccount resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Segnalazione;
