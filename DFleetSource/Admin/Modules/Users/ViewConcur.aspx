<%@ Page Title="Concur" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewConcur.aspx.cs" Inherits="DFleet.Admin.Modules.Users.ViewConcur" %>
                    ...
                    <div class="form-group row marginbottmnull">
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtDatadal" runat="server" Columns="30" MaxLength="255" CssClass="form-control datePicker" placeholder="Data Spesa Dal"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div> 
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtDataal" runat="server" Columns="30" MaxLength="255" CssClass="form-control datePicker" placeholder="Data Spesa Al"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div>  
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvConcur" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Codice Service">
                            <ItemTemplate>
                                <%# Eval("codservice")%> 
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Data">
                            <ItemTemplate>
                                <%# String.Format(CultureInfo.CurrentCulture, "{0:d}",Eval("dataspesa")) %>              
                            </ItemTemplate>
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Distanza">
                            <ItemTemplate>
                                <%# Eval("distanza")%>
                            </ItemTemplate>
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Importo Deducibile">
                            <ItemTemplate>
                                <%# Eval("importodeducibile")%>
                            </ItemTemplate>
                        </asp:TemplateField>                     
                ...
                <asp:ObjectDataSource ID="odsConcur" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectConcur" TypeName="BusinessLogic.FileTracciatiBL">
                        <SelectParameters>
