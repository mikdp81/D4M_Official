...
namespace DFleet.Admin.Modules.Users
{
    public partial class ViewConcur : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            if (!datiUtente.ReturnExistPage(65)) //controllo se la pagina è autorizzata per l'utente 
            {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioFileTracciati.SelectCountConcur(UserId, datadal, dataal, targa, Uidtenant);
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportConcur-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["C1"].Value = "Società";
                worksheet.Cells["D1"].Value = "Codice Service";
                worksheet.Cells["E1"].Value = "Data";
                worksheet.Cells["F1"].Value = "Tipo";
                worksheet.Cells["G1"].Value = "Distanza";
                worksheet.Cells["H1"].Value = "Importo";
                worksheet.Cells["I1"].Value = "Rimborso";
                worksheet.Cells["J1"].Value = "Importo Deducibile";
                ...
                List<IFileTracciati> dataExport = servizioFileTracciati.SelectConcur(UserId, datadal, dataal, targa, Uidtenant, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Denominazione + " (" + resultExport.Matricola + ")";
                        worksheet.Cells["B" + countRow].Value = resultExport.Targa;
                        worksheet.Cells["C" + countRow].Value = resultExport.Codcompany;
                        worksheet.Cells["D" + countRow].Value = resultExport.Codservice;
                        worksheet.Cells["E" + countRow].Style.Numberformat.Format = DateTimeFormatInfo.CurrentInfo.ShortDatePattern;
                        worksheet.Cells["E" + countRow].Value = resultExport.Dataspesa;
                        worksheet.Cells["F" + countRow].Value = resultExport.Tipologiaspesa;
                        worksheet.Cells["G" + countRow].Value = resultExport.Distanza;
                        worksheet.Cells["H" + countRow].Value = resultExport.Importospesa;
                        worksheet.Cells["I" + countRow].Value = resultExport.Rimborso;
                        worksheet.Cells["J" + countRow].Value = resultExport.Importodeducibile;
