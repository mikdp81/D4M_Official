...
// ***********************************************************************
// <copyright file="Carica.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class Carica : System.Web.UI.Page
    {
        ...
        protected void btnInserisci_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (servizioFileTracciati.InsertFileTracciato(SaveFile) == 1)
                                        {
                                            operazioneok += "1";

                                            /*
                                            if (ImportTracciato(filename, SaveFile.Idtipofile) == true)
                                            {
                                                operazioneok += "1";
                                            }
                                            else
                ...
                {
                    //Response.Redirect("ImportOk");
                    Response.Redirect("Carica");
                }

            }
        }

        public bool ImportTracciato(string filename, int idtipofile)
        {
            bool retVal = false;
            ...
            switch (idtipofile)
            {
                ...
                case 3: //Tracciato Fringe Benefit ACI
                    if (ImportTracciatoFringeBenefit(filename) == true)
                    {
                        retVal = true;
                    }
                    else
        ...
        public bool ImportTracciatoFringeBenefit(string filename)
        {
            bool retVal = false;
            IFileTracciatiBL servizioFileTracciati = new FileTracciatiBL();
