<%@ Page Title="Nuova Comunicazione" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="InsCom.aspx.cs" Inherits="DFleet.Admin.Modules.EPartner.InsCom" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/EPartner/ViewComunicazioni")%>" class="btn btn-info waves-effect waves-light m-t-10">Indietro</a> 
            </div>				
        </div>
    </div>
