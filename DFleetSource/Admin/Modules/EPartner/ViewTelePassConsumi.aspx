<%@ Page Title="Consumi TelePass" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewTelePassConsumi.aspx.cs" Inherits="DFleet.Admin.Modules.EPartner.ViewTelePassConsumi" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Consumi TelePass</h3>
            </div>				
        </div>
    </div>
                    ...
                    <div class="form-group row marginbottmnull">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtSearch" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Descrizione"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlTelePass" runat="server" DataSourceID="odsfuelcard" DataTextField="numerofuelcard" 
                                            DataValueField="numerofuelcard" CssClass="form-control select2" AppendDataBoundItems="True">
                                            <asp:ListItem Selected="True" Value="" Text="Dispositivo TelePass"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:ObjectDataSource ID="odsfuelcard" runat="server" SelectMethod="SelectAllTelePass" TypeName="BusinessLogic.FileTracciatiBL" >
                                            <SelectParameters>
                                                <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="Uidtenant" />
                                            </SelectParameters>
                                        </asp:ObjectDataSource>                               
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvConsumi" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Data">
                            <ItemTemplate>
                                <%# String.Format(CultureInfo.CurrentCulture, "{0:d}",Eval("dataora")) %>              
                            </ItemTemplate>
                        </asp:TemplateField>   
                ...
                <asp:ObjectDataSource ID="odsConsumi" runat="server" OldValuesParameterFormatString="original_{0}" 
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="ddlTelePass" Name="numerodispositivo" PropertyName="SelectedValue" Type="String" />
                            <asp:SessionParameter DbType="Guid" Name="Uidtenant" SessionField="UidTenant" />
