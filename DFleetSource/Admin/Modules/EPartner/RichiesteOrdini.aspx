<%@ Page Title="Richieste Ordini" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="RichiesteOrdini.aspx.cs" Inherits="DFleet.Admin.Modules.EPartner.RichiesteOrdini" %>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicOrdini" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <%# ReturnAzioni(Eval("Uid").ToString()) %>
                            </ItemTemplate>                                
                        </asp:TemplateField>     
                    </Columns>    
                ...
                <asp:ObjectDataSource ID="odsRicOrdini" runat="server" OldValuesParameterFormatString="original_{0}" 
                        SelectMethod="SelectRichiesteOrdiniPartner" TypeName="BusinessLogic.ContrattiBL">
                        <SelectParameters>
