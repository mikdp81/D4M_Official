            ...
            else
            {
                ...
                else //se admin
                {
                    ...
                    if (dataUt != null)
                    {
                        ...
                        {
                            Recuperadatiuser datiUtente = new Recuperadatiuser();
                            MailHelper.SendMail("", dataUt.Email, "", "", "", "", oggettomail, servizioUtility.InsComEmail((Guid)Membership.GetUser().ProviderUserKey, Uidcomunicazione, testo, dataTemplate.Corpo), "", datiUtente.ReturnObjectTenant());
                        }
                        ...
                        else
                        {
                            pnlMessage.Visible = true;
                            pnlMessage.CssClass = "alert alert-success";
                            lblMessage.Text = "Inserimento avvenuto correttamente <br /> <a href='" + ResolveUrl("~/Admin/Modules/EPartner/ViewComunicazioni") + "' style='color:#fff;'>Ritorna alla Lista Comunicazioni</a>";
