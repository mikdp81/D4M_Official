...
namespace DFleet.Admin.Modules.EPartner
{
    public partial class ViewContratti : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountContrattiPartner(codsocieta, UserId, marca, targa, codfornitore, numerocontratto, datadal, dataal, idstatuscontratto, Uidtenant);
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                List<IContratti> dataExport = servizioContratti.SelectContrattiPartner(codsocieta, UserId, marca, targa, codfornitore, numerocontratto, datadal, dataal, idstatuscontratto, Uidtenant, ordine, tipoordine, 100000, 1);
