<%@ Page Title="Help Desk" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewComunicazioni.aspx.cs" Inherits="DFleet.Admin.Modules.EPartner.ViewComunicazioni" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/EPartner/insCom")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12 ">
                ...
                <asp:ObjectDataSource ID="odsCom" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectComunicazioniPartner" TypeName="BusinessLogic.ComunicazioniBL">
                    <SelectParameters>
