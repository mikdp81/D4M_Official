...
// ***********************************************************************
// <copyright file="ViewTelePassConsumi.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewTelePassConsumi : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            Recuperadatiuser datiUtente = new Recuperadatiuser();
            if (!datiUtente.ReturnExistPage(83)) //controllo se la pagina è autorizzata per l'utente 
            {
        ...
        public void loadPage()
        {
            ...
            string numerodispositivo = SeoHelper.EncodeString(ddlTelePass.SelectedValue);
            Guid Uidtenant = SeoHelper.ReturnSessionTenant();
            int totaleRecord = Convert.ToInt32(ddlNRecord.SelectedValue);
            int totaleRighe = servizioFileTracciati.SelectCountConsumiTelePass(UserId, datadal, dataal, search, numerodispositivo, Uidtenant);
        ...
        {
            Response.Redirect("ViewTelePassConsumi");
        }
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportConsumiTelePass-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                List<IFileTracciati> dataExport = servizioFileTracciati.SelectConsumiTelePass(UserId, datadal, dataal, search, numerodispositivo, Uidtenant, 100000, 1);
