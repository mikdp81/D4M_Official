...
// ***********************************************************************
// <copyright file="ModCarListAuto.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ModCarListAuto : System.Web.UI.Page
    {
            ...
            if (dataOpt != null && dataOpt.Count > 0)
            {
                ...
                foreach (ICars resultOpt in dataOpt)
                {
                    ...
                    if (existopt)
                    {
                        ...
                        elencocolori += "<div class='optional-table-left'><input type='button' id='btnElimina_" + countCol + "' value='ELIMINA' class='btn' onclick='EliminaOpt(this)' />";
                        elencocolori += "<input type='hidden' id='hdElimina_" + countCol + "' value='" + uidopt + "' />";
                        elencocolori += "</div>";
                        elencocolori += "</div>";
                        countCol++;
                    }
        ...
        public void RecuperaOptional()
        {
            ...
            int countoptional = 0 + SeoHelper.IntString(hdcountcolor.Value);
                            ...
                            if (dataOpt != null && dataOpt.Count > 0)
                            {
                                foreach (ICars resultOpt in dataOpt)
                                {
                                    ...
                                    if (existopt)
                                    {
                                        ...
                                        elencooptional += "</div>";
                                        elencooptional += "<div class='optional-table-left'><input type='button' id='btnElimina_" + countoptional + "' value='ELIMINA' class='btn' onclick='EliminaOpt(this)' />";
                                        elencooptional += "<input type='hidden' id='hdElimina_" + countoptional + "' value='" + uidopt + "' />";
                                        elencooptional += "</div>";
                                        elencooptional += "</div>";
                                        countoptional++;
                                    }
