<%@ Page Title="Fringe Benefit" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewFringe.aspx.cs" Inherits="DFleet.Admin.Modules.Car.ViewFringe" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Fringe Benefit</h3>
            </div>			
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicFringe" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Assegnazione">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Emissioni">
                            <ItemTemplate>
                                <%# Eval("emissioni")%>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Fringe Base">
                            <ItemTemplate>
                                <%# Eval("fringebenefitbase")%>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Fringe Contratto">
                            <ItemTemplate>
                                <%# Eval("fringebenefit")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Periodo">
                            <ItemTemplate>
                                <%# StringPeriodo(Eval("periodo").ToString()) %>
                            </ItemTemplate>
                        </asp:TemplateField>
                                    
                        <asp:TemplateField HeaderText="Giorni">
                            <ItemTemplate>
                                <%# CalcoloGiorni(Eval("assegnatodal").ToString(), Eval("assegnatoal").ToString(), Eval("periodo").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField> 

                        <asp:TemplateField HeaderText="Giorni Mese">
                            <ItemTemplate>
                                <%# CalcoloGiorniMese(Eval("periodo").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>     

                        <asp:TemplateField HeaderText="Fringe Calcolato">
                            <ItemTemplate>
                                <%# CalcoloFringe(Eval("fringebenefit").ToString(), Eval("assegnatodal").ToString(), Eval("assegnatoal").ToString(), Eval("periodo").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>         
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicFringe" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectFringeInCorso" TypeName="BusinessLogic.ContrattiBL">
                    <SelectParameters>
