...
// ***********************************************************************
// <copyright file="ViewCodCarList.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewCodCarList : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioCar.SelectCountCarList(keysearch, Uidtenant);
            ...
            if (gvRicCodCarList.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicCodCarList.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Codici Car List: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportCodCarList-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Codice Car List";
                worksheet.Cells["B1"].Value = "Car List";
                ...
                List<ICars> dataExport = servizioCar.SelectCarList(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (ICars resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Carlist;
