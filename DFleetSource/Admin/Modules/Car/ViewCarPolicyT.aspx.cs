...
// ***********************************************************************
// <copyright file="ViewCarPolicy.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewCarPolicyT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ltCarPolicy.Text = resourceManager.GetString("carpolicy", new CultureInfo("it-IT"));
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioCar.SelectCountCarPolicy(keysearch, codsocieta, codgrade, Uidtenant);
            ...
            if (gvRicCarPolicy.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicCarPolicy.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Car Policy: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Car Policy";
                ...
                List<ICars> dataExport = servizioCar.SelectCarPolicy(keysearch, codsocieta, codgrade, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Codcarpolicy;
