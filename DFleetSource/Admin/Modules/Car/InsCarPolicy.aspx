<%@ Page Title="Inserimento Car Policy" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="InsCarPolicy.aspx.cs" Inherits="DFleet.Admin.Modules.Car.InsCarPolicy" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Inserimento Car Policy</h3>
            </div>
                    ...
                    <div class="row">    
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <asp:ListBox ID="ddlCodGrade" CssClass="select2 select2-multiple" SelectionMode="Multiple" multiple="multiple"
                                    runat="server" DataSourceID="odscodgrade"  DataTextField="grade" DataValueField="codgrade" AppendDataBoundItems="True">
                                    </asp:ListBox>  
