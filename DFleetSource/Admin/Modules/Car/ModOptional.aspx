<%@ Page Title="Modifica Optional" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ModOptional.aspx.cs" Inherits="DFleet.Admin.Modules.Car.ModOptional" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Modifica Optional</h3>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="row">    
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtCodice" runat="server" Columns="30" MaxLength="50" CssClass="form-control" placeholder="Codice" Enabled="false"></asp:TextBox> 
                            </div>
                        </div>   
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <div class="form-action">
                    ...
                    <asp:HiddenField ID="hdSottoCategoria" runat="server" />
...
<script type="text/javascript">  
    $(document).ready(function () {  
        var codcategoria1 = $(".ddlCategoria :selected").val();
        $.ajax({
            type: "POST",
            url: "../../../Handler/ListSottoCategorie.ashx?codcategoria=" + codcategoria1,
