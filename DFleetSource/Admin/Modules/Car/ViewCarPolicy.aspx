<%@ Page Title="Car Policy" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewCarPolicy.aspx.cs" Inherits="DFleet.Admin.Modules.Car.ViewCarPolicy" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Car Policy</h3>
            </div>
