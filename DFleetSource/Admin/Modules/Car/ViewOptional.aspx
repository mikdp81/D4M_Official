<%@ Page Title="Optional" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewOptional.aspx.cs" Inherits="DFleet.Admin.Modules.Car.ViewOptional" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Car/InsOptional")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo</a> 
            </div>				
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlOrdina" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                            ...
                                            <asp:ListItem Value="o.optional">Optional</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="form-group row marginbottmnull">
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group marginbottmnull">
                                    <asp:TextBox ID="txtSearch" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Optional"></asp:TextBox> 
                                </div>
                            </div>
                        </div>
                    </div> 
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicOpt" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsRicOpt" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Optional">
                            <ItemTemplate>
                               <div class="text-break width300"><%# Eval("optional")%></div>
                            </ItemTemplate>     
                            <ItemStyle Width="40%" />   
                        </asp:TemplateField>                    
                        ...
                        <asp:TemplateField HeaderText="Sottocategoria">
                            <ItemTemplate>
                               <%# Eval("sottocategoriaoptional")%>
                            </ItemTemplate>     
                            <ItemStyle Width="20%" />   
                        </asp:TemplateField>  
                        ...
                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <a href='EditOptional-<%# Eval("Uid")%>' class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Apri"><img src="../../../plugins/images/apri.svg" class="icon20" border="0" alt="" /></a>
                                <a href='DelOptional-<%# Eval("Uid")%>' onClick="return confirm('Sei sicuro di voler cancellare questo optional?');" class="text-inverse" title="" data-placement="left" data-toggle="tooltip" data-original-title="Cancella"><img src="../../../plugins/images/elimina.svg" class="icon20" border="0" alt="" /></a>
                            </ItemTemplate>        
                            <ItemStyle Width="15%" />                                
                        </asp:TemplateField>     
                    </Columns>    
                ...
                <asp:ObjectDataSource ID="odsRicOpt" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectOptional" TypeName="BusinessLogic.CarsBL">
                    <SelectParameters>
