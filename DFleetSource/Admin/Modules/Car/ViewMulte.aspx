<%@ Page Title="Lista Multe" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewMulte.aspx.cs" Inherits="DFleet.Admin.Modules.Car.ViewMulte" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                <h3 class="box-title m-b-0">Multe Pagate</h3>
            </div>			
        </div>
    </div>
...
<%--         <a class="btn btn-filter svg-icon-30 svg-icon-excel" ID="btnEsportaExcel2" runat="server" onserverclick="btnEsporta2_Click" data-original-title="Esporta Tracciato Note Credito"></a>
         <a class="btn btn-filter svg-icon-30 svg-icon-excel" ID="btnEsportaExcel3" runat="server" onserverclick="btnEsporta3_Click" data-original-title="Esporta Tracciato Excel"></a>--%>
    </div>
   </div>
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicMulte" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="CDC">
                            <ItemTemplate>
                               <%# Eval("codicecdc")%>
                            </ItemTemplate>
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Importo">
                            <ItemTemplate>
                                <div class="text-right"><%# Eval("importomultapagato")%></div>
                            </ItemTemplate>
                        </asp:TemplateField>          
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRicMulte" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectMultePagate" TypeName="BusinessLogic.MulteBL">
                    <SelectParameters>
