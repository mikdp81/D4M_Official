...
namespace DFleet.Admin.Modules.Car
{
    public partial class ViewDeltaCanone : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            if (!datiUtente.ReturnExistPage(23)) //controllo se la pagina è autorizzata per l'utente 
            {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IContratti resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Codcompany;
                        ...
                        worksheet.Cells["H" + countRow].Value = resultExport.Targa + " - delta canone - " + mese + "/" + anno.ToString().Substring(2, 2);
