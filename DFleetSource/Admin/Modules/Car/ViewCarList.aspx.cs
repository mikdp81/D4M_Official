...
namespace DFleet.Admin.Modules.Car
{
    public partial class ViewCarList : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioCar.SelectCountCarListAuto(codcarlist, codfornitore, marca, modello, Uidtenant);
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                worksheet.Cells["B1"].Value = "Codice Fornitore";
                worksheet.Cells["C1"].Value = "Codjato Auto";
                worksheet.Cells["D1"].Value = "Marca";
                ...
                List<ICars> dataExport = servizioCar.SelectCarListAuto(codcarlist, codfornitore, marca, modello, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (ICars resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Codfornitore;
                        worksheet.Cells["C" + countRow].Value = resultExport.Codjatoauto;
                        worksheet.Cells["D" + countRow].Value = resultExport.Marca;
