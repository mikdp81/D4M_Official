...
// ***********************************************************************
// <copyright file="ViewOptional.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewOptional : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioCar.SelectCountOptional(keysearch, Uidtenant);
            ...
            if (gvRicOpt.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicOpt.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Optional: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportOpt-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Optional";
                worksheet.Cells["B1"].Value = "Categoria";
                worksheet.Cells["C1"].Value = "Sottocategoria";
                ...
                List<ICars> dataExport = servizioCar.SelectOptional(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Optional;
                        worksheet.Cells["B" + countRow].Value = resultExport.Categoriaoptional;
                        worksheet.Cells["C" + countRow].Value = resultExport.Sottocategoriaoptional;
