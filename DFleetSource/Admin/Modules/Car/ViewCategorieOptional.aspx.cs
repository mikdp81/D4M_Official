...
// ***********************************************************************
// <copyright file="ViewCategorieOptional.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewCategorieOptional : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioCar.SelectCountCategoriaOptional(keysearch, Uidtenant);
            ...
            if (gvRicCatOpt.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicCatOpt.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Categorie: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportCatOpt-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                List<ICars> dataExport = servizioCar.SelectCategoriaOptional(keysearch, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    {
                        worksheet.Cells["A" + countRow].Value = resultExport.Categoriaoptional;
