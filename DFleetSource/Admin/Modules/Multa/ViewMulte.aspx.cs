...
namespace DFleet.Admin.Modules.Multa
{
    public partial class ViewMulte : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioMulte.SelectCountMulte(keysearch, idtipotrasmissione, idstatuslavorazione, idstatuspagamento, codtipomulta, datadal, dataal, UserId, Uidtenant);
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                //titoli intestazione
                worksheet.Cells["A1"].Value = "Verbale";
                worksheet.Cells["B1"].Value = "Notificato il";
                worksheet.Cells["C1"].Value = "Targa";
                worksheet.Cells["D1"].Value = "Driver";
                worksheet.Cells["E1"].Value = "Società";
                worksheet.Cells["F1"].Value = "Lavorazione";
                worksheet.Cells["G1"].Value = "Pagamento";
                worksheet.Cells["H1"].Value = "Tipo";
                worksheet.Cells["I1"].Value = "Punti";
                worksheet.Cells["J1"].Value = "Importo 5gg";
                ...
                List<IMulte> dataExport = servizioMulte.SelectMulte(keysearch, idtipotrasmissione, idstatuslavorazione, idstatuspagamento, codtipomulta, datadal, dataal, UserId, Uidtenant, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IMulte resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Datanotifica;
                        worksheet.Cells["C" + countRow].Value = resultExport.Targa;
                        worksheet.Cells["D" + countRow].Value = resultExport.Denominazione;
                        worksheet.Cells["E" + countRow].Value = resultExport.Societa;
                        worksheet.Cells["F" + countRow].Value = resultExport.Statuslavorazione;
                        worksheet.Cells["G" + countRow].Value = resultExport.Statuspagamento;
                        worksheet.Cells["H" + countRow].Value = resultExport.Tipotrasmissione;
                        worksheet.Cells["I" + countRow].Value = resultExport.Punti;
                        worksheet.Cells["J" + countRow].Value = resultExport.Importomultascontato;
