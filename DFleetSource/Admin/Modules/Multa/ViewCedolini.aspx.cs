...
// ***********************************************************************
// <copyright file="ViewCedolini.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewCedolini : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int idtipologiacedolino = SeoHelper.IntString(ddlTipologiaCed.Text);

            int totaleRecord = Convert.ToInt32(ddlNRecord.SelectedValue);
            int totaleRighe = servizioMulte.SelectCountCedolini(datadal, dataal, UserId, idtipologiacedolino);
            ...
            if (gvRicCedolini.HeaderRow != null)
            {
                //aggiunge il tag THEAD nell'intestazione della gridview
                gvRicCedolini.HeaderRow.TableSection = TableRowSection.TableHeader;
            }


            lblNumRecord.Text = "Cedolini: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
        ...
        {
            Response.Redirect("ViewCedolini");
        }
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportCedolini-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["C1"].Value = "Importo";
                ...
                List<IMulte> dataExport = servizioMulte.SelectCedolini(datadal, dataal, UserId, idtipologiacedolino, ordine, tipoordine, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IMulte resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["B" + countRow].Value = resultExport.Datains;
                        worksheet.Cells["C" + countRow].Value = resultExport.Importo;
