<%@ Page Title="Lista Cedolini" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind  ="ViewCedolini.aspx.cs" Inherits="DFleet.Admin.Modules.Multa.ViewCedolini" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                <h3 class="box-title m-b-0">Lista Cedolini</h3>
            </div>				
        </div>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlOrdina" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                            ...
                                            <asp:ListItem Value="c.datains">Data</asp:ListItem>
                                            <asp:ListItem Value="c.importo">Importo</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group row marginbottmnull"> 
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:DropDownList ID="ddlTipologiaCed" runat="server" DataSourceID="odstipced" DataTextField="tipologiacedolino" 
                                            DataValueField="idtipologiacedolino" CssClass="form-control" AppendDataBoundItems="True">
                                            <asp:ListItem Selected="True" Value="0" Text="Tipologia Trattenuta"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:ObjectDataSource ID="odstipced" runat="server" SelectMethod="SelectAllTipologiaCedolini" TypeName="BusinessLogic.MulteBL">
                                        </asp:ObjectDataSource>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtDatadal" runat="server" Columns="30" MaxLength="255" CssClass="form-control datePicker" placeholder="Data pagamento dal"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div> 
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group marginbottmnull">
                                        <asp:TextBox ID="txtDataal" runat="server" Columns="30" MaxLength="255" CssClass="form-control datePicker" placeholder="Data pagamento al"></asp:TextBox> 
                                    </div>
                                </div>
                            </div>
                        </div> 
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicCedolini" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsRicCedolini" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tipo Trattenuta">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Importo Pagamento">
                            <ItemTemplate>
                               <%# String.Format(CultureInfo.CurrentCulture, "{0:n}",Eval("importo")) %>
                            </ItemTemplate>
                        </asp:TemplateField> 
                ...
                <asp:ObjectDataSource ID="odsRicCedolini" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectCedolini" TypeName="BusinessLogic.MulteBL">
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="ddlTipologiaCed" Name="idtipologiacedolino" PropertyName="SelectedValue" Type="Int32" />
