...
// ***********************************************************************
// <copyright file="ViewCarPolicyDriver.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class ViewCarPolicyDriver : System.Web.UI.Page
    {
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            Recuperadatiuser datiUtente = new Recuperadatiuser();
            if (!datiUtente.ReturnExistPage(51)) //controllo se la pagina è autorizzata per l'utente 
            {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountUserCarPolicy(search, SeoHelper.EncodeString(hdcodsocietaapprovatore.Value), UserId, datadal, dataal, Uidtenant);
            ...
            lblNumRecord.Text = "Car Policy Driver: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
                lblMessage.Text = "Nessun dato disponibile. Ricerca con altri parametri.";
                pnlMessage.Visible = true;
        ...
        {
            Response.Redirect("ViewCarPolicyDriver");
        }
        ...
        protected void btnEsporta_Click(object sender, EventArgs e)
        {
            ...
            {
                string namesheet = "ReportCarPolicy-" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year;
                ...
                worksheet.Cells["B1"].Value = "CarPolicy Driver";
                worksheet.Cells["C1"].Value = "CarPolicy Assegnata";
                worksheet.Cells["D1"].Value = "Preassegnazione";
                worksheet.Cells["E1"].Value = "Attivato il";
                worksheet.Cells["F1"].Value = "Invio e-mail";
                ...
                List<IContratti> dataExport = servizioContratti.SelectUserCarPolicy(search, SeoHelper.EncodeString(hdcodsocietaapprovatore.Value), UserId, datadal, dataal, Uidtenant, 10000, 1);
                ...
                if (dataExport != null && dataExport.Count > 0)
                {
                    ...
                    foreach (IContratti resultExport in dataExport)
                    {
                        ...
                        worksheet.Cells["C" + countRow].Value = resultExport.Fasciacarpolicy;
                        worksheet.Cells["D" + countRow].Value = resultExport.Preassegnazione;
                        worksheet.Cells["E" + countRow].Style.Numberformat.Format = DateTimeFormatInfo.CurrentInfo.ShortDatePattern;
                        worksheet.Cells["E" + countRow].Value = ReturnData(resultExport.Dataapprovazione.ToString());
                        worksheet.Cells["F" + countRow].Style.Numberformat.Format = DateTimeFormatInfo.CurrentInfo.ShortDatePattern;
                        worksheet.Cells["F" + countRow].Value = ReturnData(resultExport.Datamail.ToString());
                        countRow++;
                    }
                }
