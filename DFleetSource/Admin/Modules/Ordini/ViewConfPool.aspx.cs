...
namespace DFleet.Admin.Modules.Ordini
{
    public partial class ViewConfPool : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("EditConfermaPool-" + SeoHelper.EncodeString(hduid.Value));
        }

        protected void btnNonAutorizza_Click(object sender, EventArgs e)
        {
            Response.Redirect("EditScartaPool-" + SeoHelper.EncodeString(hduid.Value));
        }
    }
}
