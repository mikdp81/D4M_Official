<%@ Page Title="Consegna Auto" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewRitiroAuto.aspx.cs" Inherits="DFleet.Admin.Modules.Ordini.ViewRitiroAuto" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Consegna Auto</h3>
            </div>		
        </div>
    </div>
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">
                ...
                <asp:GridView ID="gvRitiroAuto" runat="server"
                        AutoGenerateColumns="False" DataSourceID="odsRitiroAuto" CssClass="display nowrap dataTable" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Consegna">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Azioni">
                            <ItemTemplate>
                                <a href="../Ordini/EditConsegna-<%# Eval("idassegnazione")%>" class="text-inverse p-r-10" data-toggle="tooltip" title="" data-placement="left" data-original-title="Consegna">Consegna</a>           
                            </ItemTemplate>
                        </asp:TemplateField> 
                    </Columns>    
                    <PagerStyle HorizontalAlign="Right" />    
                </asp:GridView>
                <asp:ObjectDataSource ID="odsRitiroAuto" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectRitiriAuto" TypeName="BusinessLogic.ContrattiBL">
                    <SelectParameters>
