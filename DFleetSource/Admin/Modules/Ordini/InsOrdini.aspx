<%@ Page Title="Inserimento Ordine" EnableEventValidation="false" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="InsOrdini.aspx.cs" Inherits="DFleet.Admin.Modules.Ordini.InsOrdini" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Inserimento Ordine</h3>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="form-body">
                           ...
                           <div class="row">
                               <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div style="cursor:pointer;" id="buttonnewcar">Se non esistente clicca qui per inserire nuova auto</div>
                                    </div>
                                </div>                     
                                <div class="col-md-3">
                                    <div class="form-group">
                    ...
                    <div class="row" id="blocknewcar" style="display:none">      
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Codjato Auto </label>
                                <asp:TextBox ID="txtCodjatoAutoNew" runat="server" Columns="30" MaxLength="20" CssClass="form-control" placeholder="Codjato Auto"></asp:TextBox> 
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Car List</label>
                                <asp:DropDownList ID="ddlCodCarListNew" runat="server" CssClass="form-control select2" AppendDataBoundItems="True"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtMarcaNew" runat="server" Columns="30" MaxLength="50" CssClass="form-control" placeholder="Marca"></asp:TextBox>
                            </div>
                        </div>  
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Modello</label>
                                <asp:TextBox ID="txtModelloNew" runat="server" Columns="30" MaxLength="255" CssClass="form-control" placeholder="Modello"></asp:TextBox> 
                            </div>
                        </div>                      
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">Fornitore </label>                                
                                <asp:DropDownList ID="ddlFornitoreNew" runat="server" DataSourceID="odsfornitore" DataTextField="fornitore" 
