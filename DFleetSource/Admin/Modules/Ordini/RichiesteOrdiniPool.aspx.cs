...
// ***********************************************************************
// <copyright file="RichiesteOrdiniPool.aspx.cs" company="">
//     . All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    public partial class RichiesteOrdiniPool : System.Web.UI.Page
    {
        ...
        public void loadPage()
        {
            ...
            int totaleRighe = servizioContratti.SelectCountRichiesteOrdiniPool(search, codsocieta, codgrade, datadal, dataal, UserId, idstatusordine, Uidtenant);
            ...
            lblNumRecord.Text = "Richieste Ordini Pool: " + HttpUtility.HtmlEncode(totaleRighe);
            if (totaleRighe == 0)
            {
                lblMessage.Text = "Nessun dato disponibile. Ricerca con altri parametri.";
                pnlMessage.Visible = true;
        ...
        {
            Response.Redirect("RichiesteOrdiniPool");
        }
