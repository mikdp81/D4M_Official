<%@ Page Title="Ordine" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ViewConfPool.aspx.cs" Inherits="DFleet.Admin.Modules.Ordini.ViewConfPool" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Admin/Modules/Ordini/RichiesteOrdiniPool")%>" class="btn btn-info waves-effect waves-light m-t-10">Torna alla Lista</a> 
            </div>		
        </div>
    </div>

    <div style="text-align:center;margin-bottom:30px;">
        <asp:Button ID="btnAutorizza" runat="server" onclick="btnAutorizza_Click" Text="Accetta" CssClass="btn btn-success" /> 
        <asp:Button ID="btnNonAutorizza" runat="server" onclick="btnNonAutorizza_Click" Text="Rifiuta" CssClass="btn btn-success" />
    </div>
