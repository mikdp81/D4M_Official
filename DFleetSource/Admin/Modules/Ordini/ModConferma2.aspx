<%@ Page Title="Firma Manuale" Language="C#" MasterPageFile="~/Admin/MasterpageAdmin.Master" AutoEventWireup="true" CodeBehind="ModConferma2.aspx.cs" Inherits="DFleet.Admin.Modules.Ordini.ModConferma2" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                <h3 class="box-title m-b-0">Firma Manuale</h3>
            </div>		
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-body">
                    <div class="row">                 
                        <div class="col-md-6">
                            <div class="form-group font-18"><asp:Label ID="lblfileofferta" runat="server" Text=""></asp:Label> <br /><br />
                                <label class="control-label">Carica File</label> (sono accettati solo i file .pdf)
