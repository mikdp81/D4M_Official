<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPasswordOK.aspx.cs" Inherits="DFleet.ResetPasswordOK" %>
                    ...
                    <div class="column">
                        <div class="card">
                            ...
                            <div style="margin-top:30px;">
                                <span style="font-size:12px; color:#d43f3a">La password &egrave; stata cambiata correttamente. <a href="LoginRenter">Login</a> </span>
                            </div>    
