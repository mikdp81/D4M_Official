<%@ Page Title="Prenotazione Auto di servizio" EnableEventValidation="false" Language="C#" MasterPageFile="~/Users/MasterpageUsers.Master" AutoEventWireup="true" CodeBehind="InsAutoServizio.aspx.cs" Inherits="DFleet.Users.Modules.Dash.InsAutoServizio" %>
        ...
        <div class="white-box">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-body">
                        <div class="col-md-12">
                            <h3>Cerca disponibilit&agrave; per modello</h3>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 m-l-5">
                            ...
                            <asp:Button ID="btnInserisci" runat="server" onclick="btnInserisci_Click" Text="Prosegui" CssClass="btn btn-success" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="white-box">
            <div class="row">
                <div class="col-12">
                    <div class="form-body">
                        <div class="col-md-12">
                            <h3>Cerca disponibilit&agrave; per data</h3>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 m-l-5">
                            <asp:Button ID="btnInserisci2" runat="server" onclick="btnInserisci2_Click" Text="Prosegui" CssClass="btn btn-success" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="white-box">
            <div class="row">
                <div class="col-12">
                    ...
                    <h4>Auto:  <asp:Label ID="lblTarga" runat="server" Text=""></asp:Label></h4><br />
                    <div id="calendar"></div>
                </div>
            </div>
        </div>
