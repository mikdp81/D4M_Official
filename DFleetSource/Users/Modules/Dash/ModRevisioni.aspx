<%@ Page Title="Modifica Revisione" Language="C#" MasterPageFile="~/Users/MasterpageUsers.Master" AutoEventWireup="true" CodeBehind="ModRevisioni.aspx.cs" Inherits="DFleet.Users.Modules.Dash.ModRevisioni" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Users/Modules/Dash/ViewRevisioni")%>" class="btn btn-info waves-effect waves-light m-t-10">Torna alla Lista</a> 
            </div>				
        </div>
    </div>
