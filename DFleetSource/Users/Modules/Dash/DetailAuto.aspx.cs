...
namespace DFleet.Users.Modules.Dash
{
    public partial class DetailAuto : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                if (Guid.TryParse(SeoHelper.EncodeString(Request.QueryString["uid"]), out Guid uid))
                {
                    ...
                    if (dataC != null)
                    {
                        ...
                        lblAlimentazione.Text = dataC.Alimentazionecontratto;
                        lblCilindrata.Text = dataC.Cilindratacontratto;
        ...
        public string ReturnFotoAuto(string fotoauto)
        {
            ...
            {
                retVal = "<img src='../../../DownloadFile?type=auto&nomefile=" + fotoauto + "' class='img-responsive' style='max-width: 100% !important;'>";
            }
            else
            {
                retVal = "<img src='../../../Repository/auto/nofoto.png' class='img-responsive' style='max-width: 100% !important;'>";
            }
