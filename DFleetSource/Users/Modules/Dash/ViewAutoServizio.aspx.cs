...
namespace DFleet.Users.Modules.Dash
{
    public partial class ViewAutoServizio : System.Web.UI.Page
    {
        ...
        {
            hdusers.Value = Membership.GetUser().ProviderUserKey.ToString();
            loadPage();
        }
        ...
        public string ReturnCompilazione(string count)
        {
            string retVal;
        ...
        public string ReturnLinkLibretto(string autorizzato, string idassegnazione)
        {
            if (autorizzato == "1")
            {
                return "<a href='EditAutoServizio-" + idassegnazione + "' class='text-inverse p-r-10' data-toggle='tooltip' title='' data-placement='left' data-original-title='Apri'><img src = '../../../plugins/images/apri.svg' class='icon20' border='0' alt='' /></a>";
            }
            else
            {
                return "";
