<%@ Page Title="Nuova Comunicazione" Language="C#" MasterPageFile="~/Users/MasterpageUsers.Master" AutoEventWireup="true" CodeBehind="InsCom.aspx.cs" Inherits="DFleet.Users.Modules.Dash.InsCom" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Users/Modules/Dash/ViewComunicazioni")%>" class="btn btn-info waves-effect waves-light m-t-10">Indietro</a> 
            </div>				
        </div>
    </div>
