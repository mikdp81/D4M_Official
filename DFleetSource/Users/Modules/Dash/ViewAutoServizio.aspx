<%@ Page Title="Elenco Auto di servizio" Language="C#" MasterPageFile="~/Users/MasterpageUsers.Master" AutoEventWireup="true" CodeBehind="ViewAutoServizio.aspx.cs" Inherits="DFleet.Users.Modules.Dash.ViewAutoServizio" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Users/Modules/Dash/InsAutoServizio")%>" class="btn btn-info waves-effect waves-light m-t-10">Prenota</a> 
            </div>				
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <asp:GridView ID="gvRicContratti" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Libretto compilato">
                            <ItemTemplate>
                               <%# ReturnCompilazione(Eval("totuser").ToString())%>
                            </ItemTemplate>
                        </asp:TemplateField>                          

                        <asp:TemplateField HeaderText="Azioni"> 
                            <ItemTemplate>
                                <%# ReturnLinkLibretto(Eval("autorizzatoadmin").ToString(), Eval("idassegnazione").ToString()) %>
                            </ItemTemplate>                                
                        </asp:TemplateField>    
                    </Columns>    
