<%@ Page Title="Configura Auto" Language="C#" MasterPageFile="~/Users/MasterpageUsers.Master" AutoEventWireup="true" CodeBehind="ScegliAuto.aspx.cs" Inherits="DFleet.Users.Modules.Ordini.ScegliAuto" %>
...
<div class="col-sm-12">
    <div class="white-box">
        <div class="row">
            <div class="col-md-7">
                <h3 class="box-title m-b-0">Configurazione Auto Nuova</h3>
            </div>	
    ...
    <div class="white-box">
        <div class="row">
            <div class="col-12">             
                <div class="text-center font-18 bg-verde text-white m-b-30">OPTIONAL CANONE (addebito mensile iva esclusa) <br />&euro; <span id="totale">0</span></div>
                                
                
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#aggiuntivi" aria-controls="aggiuntivi" role="tab" data-toggle="tab" aria-expanded="true"><span class="visible-xs">Optional aggiuntivi</i></span><span class="hidden-xs"> Optional aggiuntivi</span></a></li>
                    <li role="presentation" class=""><a href="#serie" aria-controls="serie" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs">Optional di serie</i></span> <span class="hidden-xs">Optional di serie</span></a></li>
                </ul>
    ...
    <div class="text-center"><asp:Button ID="btnInserisci" runat="server" onclick="btnInserisci_Click" Text="SALVA CONFIGURAZIONE" CssClass="btn btn-primary font-18 " /> </div><br /><br /><br /><br /><br />
    ...
    <asp:HiddenField ID="hdcanoneleasing" runat="server" />
    <asp:HiddenField ID="hdidapprovazione" runat="server" />
    <asp:HiddenField ID="hdcount" runat="server" />
    <asp:HiddenField ID="hdcountcolor" runat="server" />
    <asp:HiddenField ID="hdimportolimiteoptional" runat="server" />
...
<script type="text/javascript">  
    $(document).ready(function() {  
        $(".codoptional").click(function () {
            var importomassimooptonal = new Number($("#ContentBody_hdimportolimiteoptional").val());
            ...
            $("#totale").html(totalecalcolato.toFixed(2));

            if (totalecalcolato > importomassimooptonal) {
                alert("ATTENZIONE: superando gli " + importomassimooptonal + " € di optional si dovrà attendere l'autorizzazione da parte della Function di riferimento");
            }
        });   
