<%@ Page Title="Ordine" Language="C#" MasterPageFile="~/Users/MasterpageUsers.Master" AutoEventWireup="true" CodeBehind="ViewConfPool.aspx.cs" Inherits="DFleet.Users.Modules.Ordini.ViewConfPool" %>
