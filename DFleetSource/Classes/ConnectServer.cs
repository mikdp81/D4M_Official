...
public class NetworkConnection : IDisposable
{
    ...
    public NetworkConnection(string networkName, NetworkCredential credentials)
    {
        ...
        var result = WNetUseConnection(IntPtr.Zero, netResource, credentials.Password, credentials.UserName, 0, null, null, null);
    ...
    public static int CloseConnection(string path)
    {
        int result = WNetCancelConnection(@path, true);
