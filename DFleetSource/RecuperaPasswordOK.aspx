<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecuperaPasswordOK.aspx.cs" Inherits="DFleet.RecuperaPasswordOK" %>
                    ...
                    <div class="column">
                        <div class="card">
                            ...
                            <div style="margin-top:30px;">
                                <span style="font-size:12px; color:#d43f3a">E' stata inviata una mail all'indirizzo inserito, se esistente nei nostri archivi. </span>
                            </div>    
