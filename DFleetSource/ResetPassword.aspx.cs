    ...
    public partial class ResetPassword : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                if (Guid.TryParse(SeoHelper.EncodeString(Request.QueryString["uid"]), out Guid uid))
                {
                    ...
                    if (data != null)
                    {
                        ...
                        var setupInfo = tfa.GenerateSetupCode("D4M", data.Email, data.Email, false, 3);//the width and height of the Qr Code
        ...
        protected void btnInvia_Click(object sender, EventArgs e)
        {
            ...
            if (!ValidatePassword(txtNuovaPassword.Text))
            {
                ...
                error += "La password deve essere lunga almeno 8 caratteri, contenere almeno un carattere minuscolo, maiuscolo, numerico e speciale(#?!@$%^&*-.)<br />";
            }
            else
            {
