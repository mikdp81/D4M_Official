            ...
            else
            {
                ...
                if (servizioComunicazioni.InsertComunicazione(MailNew) == 1)
                {
                    ...
                    if (data != null)
                    {
                        ...
                        {
                            MailHelper.SendMail("", servizioAccount.DetailId((Guid)Membership.GetUser().ProviderUserKey).Email, emaildelegato1, emaildelegato2, emaildelegato3, "", oggettomail, servizioUtility.InsComEmail((Guid)Membership.GetUser().ProviderUserKey, Uidcomunicazione, testo, dataTemplate.Corpo), "", datiUtente.ReturnObjectTenant());
                        }
                        ...
                        else
                        {
                            ...
                            lblMessage.Text = "Inserimento avvenuto correttamente <br /> <a href='" + ResolveUrl("~/Partner/Modules/Dash/ViewComunicazioni") + "' style='color:#fff;'>Ritorna alla Lista Comunicazioni</a>";
