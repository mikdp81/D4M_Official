...
namespace DFleet.Partner.Modules.Dash
{
    public partial class Procedure : System.Web.UI.Page
    {
        ...
        public string ReturnModuloFirmato(string modulofirmato, string note, string checkdoc, string tipomodulo, string cittaresidenza, 
            string indirizzoresidenza, string civicoresidenza, string cittaresidenzadelegato, string indirizzoresidenzadelegato, string civicoresidenzadelegato, string Uid)
        {
            string retVal = "";
            string tipofile = "";
            ...
            {
                if (cittaresidenza != cittaresidenzadelegato)
                {
                    retVal += "<br /><a href='../../../Repository/documenti/Modulo-autocertificazione-di-convivenza.doc' target='_blank'>Scarica firma il modulo di autocertificazione</a><br />";
                    retVal += "<a href='ModuloConv-" + SeoHelper.EncodeString(Uid) + "' target='_blank'>Carica il modulo di autocertificazione</a><br /> ";
                }
            }
