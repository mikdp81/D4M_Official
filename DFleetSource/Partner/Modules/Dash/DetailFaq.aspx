<%@ Page Title="FAQ" Language="C#" MasterPageFile="~/Partner/MasterpagePartner.Master" AutoEventWireup="true" CodeBehind="DetailFaq.aspx.cs" Inherits="DFleet.Partner.Modules.Dash.DetailFaq" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Partner/Modules/Dash/ViewFAQ")%>" class="btn btn-info waves-effect waves-light m-t-10">Torna alle Faq</a> 
            </div>				
        </div>
    </div>
