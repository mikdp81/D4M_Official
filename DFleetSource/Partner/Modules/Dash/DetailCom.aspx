<%@ Page Title="Lista Comunicazioni" Language="C#" MasterPageFile="~/Partner/MasterpagePartner.Master" AutoEventWireup="true" CodeBehind="DetailCom.aspx.cs" Inherits="DFleet.Partner.Modules.Dash.DetailCom" %>
				    ...
				    <Columns>
					    <asp:TemplateField HeaderText="">
						    <ItemTemplate>
                                ...
                                <div class="white-box">
                                    <div class="m-b-30"><h5><%# ReturnUtente(Eval("cognome").ToString(), Eval("UserIdMittente").ToString()) %> </h5></div>
