<%@ Page Title="Help Desk" Language="C#" MasterPageFile="~/Partner/MasterpagePartner.Master" AutoEventWireup="true" CodeBehind="ViewComunicazioni.aspx.cs" Inherits="DFleet.Partner.Modules.Dash.ViewComunicazioni" %>
    ...
    <div class="white-box">
        <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="<%=ResolveUrl("~/Partner/Modules/Dash/InsCom")%>" class="btn btn-info waves-effect waves-light m-t-10">Nuovo Ticket</a> 
            </div>			
        </div>
    </div>
