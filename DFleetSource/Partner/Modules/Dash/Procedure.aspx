<%@ Page Title="Procedure" Language="C#" MasterPageFile="~/Partner/MasterpagePartner.Master" AutoEventWireup="true" CodeBehind="Procedure.aspx.cs" Inherits="DFleet.Partner.Modules.Dash.Procedure" %>
                        ...
                        <asp:TemplateField HeaderText="Download">
                            <ItemTemplate>
                                <%# ReturnModuloFirmato(Eval("modulofirmato").ToString(), Eval("noteamministrazione").ToString(), Eval("checkdoc").ToString(), "1",
                                    ...
                                    Eval("Indirizzoresidenzadelegato").ToString(), Eval("Civicoresidenzadelegato").ToString(), Eval("Uid").ToString())%>           
                            </ItemTemplate>
                        </asp:TemplateField> 
                    </Columns>    
